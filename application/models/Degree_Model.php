...
class Degree_Model extends CI_Model {
    ...
    */
    public function get_all($filters = array(), $page = 0, $per_page = 10, $orders = array(), $fetch_as = Orm::FETCH_OBJECTS) {
        ...
        $this->db->select('d.*');
        $this->db->distinct();
        $this->db->from(Orm_Degree::get_table_name().' AS d');
        ...
        if (isset($filters['is_undergraduate'])) {
            $this->db->where('d.is_undergraduate', $filters['is_undergraduate']);
        }
        ...
        switch($fetch_as) {
            ...
            return Orm_Degree::to_object($this->db->get()->row_array());
            break;
            case Orm::FETCH_OBJECTS:
            $objects = array();
            foreach($this->db->get()->result_array() as $row) {
                $objects[] = Orm_Degree::to_object($row);
            }
            return $objects;
            break;
    ...
    */
    public function insert($params = array()) {
        $this->db->insert(Orm_Degree::get_table_name(), $params);
    ...
    */
    public function update($id, $params = array()) {
        return $this->db->update(Orm_Degree::get_table_name(), $params, array('id' => (int) $id));
    }
    ...
    */
    public function delete($id) {
        return $this->db->update(Orm_Degree::get_table_name(), array('is_deleted'=>1), array('id' => (int) $id));
//        return $this->db->delete(Orm_Degree::get_table_name(), array('id' => (int) $id));
    }
