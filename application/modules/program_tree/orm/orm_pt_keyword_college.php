...
class Orm_Pt_Keyword_College extends Orm {
    
    protected static $table_name = 'pt_keyword_college';
    
    /**
    * @var $instances Orm_Pt_Keyword_College[]
    */
    ...
    */
    ...
    /**
    * @return Pt_Keyword_College_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Pt_Keyword_College_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Pt_Keyword_College[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Pt_Keyword_College();
    }
