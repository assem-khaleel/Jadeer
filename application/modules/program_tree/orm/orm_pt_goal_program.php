...
class Orm_Pt_Goal_Program extends Orm {
    
    protected static $table_name = 'pt_goal_program';
    
    /**
    * @var $instances Orm_Pt_Goal_Program[]
    */
    ...
    */
    ...
    /**
    * @return Pt_Goal_Program_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Pt_Goal_Program_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Pt_Goal_Program[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Pt_Goal_Program();
    }
