...
class Orm_Pt_College_Program_Relation extends Orm {
    
    protected static $table_name = 'pt_college_program_relation';
    
    /**
    * @var $instances Orm_Pt_College_Program_Relation[]
    */
    ...
    */
    ...
    /**
    * @return Pt_College_Program_Relation_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Pt_College_Program_Relation_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Pt_College_Program_Relation
    */
    ...
    * @param array $orders
    *
    * @return Orm_Pt_College_Program_Relation[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Pt_College_Program_Relation();
    }
