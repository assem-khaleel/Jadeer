...
class Orm_Pt_Keyword_Uni extends Orm {
    
    protected static $table_name = 'pt_keyword_uni';
    
    /**
    * @var $instances Orm_Pt_Keyword_Uni[]
    */
    ...
    */
    ...
    /**
    * @return Pt_Keyword_Uni_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Pt_Keyword_Uni_Model');
    }
