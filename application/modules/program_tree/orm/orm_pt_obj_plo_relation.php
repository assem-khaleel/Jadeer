...
class Orm_Pt_Obj_Plo_Relation extends Orm {
    
    protected static $table_name = 'pt_obj_plo_relation';
    
    /**
    * @var $instances Orm_Pt_Obj_Plo_Relation[]
    */
    ...
    */
    ...
    /**
    * @return Pt_Obj_Plo_Relation_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Pt_Obj_Plo_Relation_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Pt_Obj_Plo_Relation
    */
    ...
    * @param array $orders
    *
    * @return Orm_Pt_Obj_Plo_Relation[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Pt_Obj_Plo_Relation();
    }
