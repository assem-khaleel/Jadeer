 ...
 * Time: 03:43 م
 */
class Orm_Fp_Static_Book_Published_Book extends Orm_Fp_Static
{
    // 73 Book Title
    /**
     * draw the text for the input id = 73 " Book Title"
     * @return object|string
     */
    protected function draw_73() {
     ...
     * @param $arabic_value
     */
    protected function validate_73($deadline_id, $english_value, $arabic_value) {
    ...
    /**
     * draw the date for the input id = 74 "Reviewed Date"
     * @return object|string
     */
    protected function draw_74() {
     ...
     * @param $arabic_value
     */
    protected function validate_74($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
