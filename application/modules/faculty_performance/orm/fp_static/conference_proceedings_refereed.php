 ...
 * Time: 03:35 م
 */
class Orm_Fp_Static_Conference_Proceedings_Refereed extends Orm_Fp_Static
{
    // 62 Name
    /**
     * draw the text for the input id = 62
     * @return object|string
     */
    protected function draw_62() {
     ...
     * @param $arabic_value
     */
    protected function validate_62($deadline_id, $english_value, $arabic_value) {
    ...
    // 63 Appeared and Accepted

    /**
     * draw the text for the input id = 63
     * @return object|string
     */
    protected function draw_63() {
        return self::get_ci()->load->view('static/text',['static' => $this],true);
    }
     ...
     * @param $arabic_value
     */
    protected function validate_63($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
