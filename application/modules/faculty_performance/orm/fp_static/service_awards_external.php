 ...
 * Time: 04:49 م
 */
class Orm_Fp_Static_Service_Awards_External extends Orm_Fp_Static
{
    // 134 Award Name
    /**
     * draw the text for the input id = 134
     * @return object|string
     */
    protected function draw_134() {
     ...
     * @param $arabic_value
     */
    protected function validate_134($deadline_id, $english_value, $arabic_value) {
