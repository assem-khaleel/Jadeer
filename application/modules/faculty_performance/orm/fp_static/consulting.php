 ...
 * Time: 04:51 م
 */
class Orm_Fp_Static_Consulting extends Orm_Fp_Static
{
    //136 Committee Name
    /**
     * draw the text for the input id = 136
     * @return object|string
     */
    protected function draw_136() {
     ...
     * @param $arabic_value
     */
    protected function validate_136($deadline_id, $english_value, $arabic_value) {
    ...
    /**
     * draw the number for the input id = 137
     * @return object|string
     */
    protected function draw_137() {
     ...
     * @param $arabic_value
     */
    protected function validate_137($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
