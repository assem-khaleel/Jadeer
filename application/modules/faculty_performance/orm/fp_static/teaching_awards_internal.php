 ...
 * Time: 04:45 م
 */
class Orm_Fp_Static_Teaching_Awards_Internal extends Orm_Fp_Static
{
    // 131 Award Name
    /**
     * draw the text for the input id = 131
     * @return object|string
     */
    protected function draw_131() {
     ...
     * @param $arabic_value
     */
    protected function validate_131($deadline_id, $english_value, $arabic_value) {
