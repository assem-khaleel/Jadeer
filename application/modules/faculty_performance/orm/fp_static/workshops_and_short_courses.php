 ...
 * Time: 03:48 م
 */
class Orm_Fp_Static_Workshops_And_Short_Courses extends Orm_Fp_Static
{
    // 79 Presentation Title
    /**
     * draw the text for the input id = 79
     * @return object|string
     */
    protected function draw_79() {
     ...
     * @param $arabic_value
     */
    protected function validate_79($deadline_id, $english_value, $arabic_value) {
    ...
    /**
     * draw the date for the input id = 81
     * @return object|string
     */
    protected function draw_81() {
     ...
     * @param $arabic_value
     */
    protected function validate_81($deadline_id, $english_value, $arabic_value) {
    ...
    // 82 Meeting or Conference

    /**
     * draw the text for the input id = 82
     * @return object|string
     */
    protected function draw_82() {
        return self::get_ci()->load->view('static/text',['static' => $this],true);
    }
     ...
     * @param $arabic_value
     */
    protected function validate_82($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
