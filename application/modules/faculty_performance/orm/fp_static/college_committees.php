 ...
 * Time: 04:33 م
 */
class Orm_Fp_Static_College_Committees extends  Orm_Fp_Static
{
    //17 Committee Name
    /**
     * draw the text for the input id = 17 "Committee Name"
     * @return object|string
     */
    protected function draw_17() {
     ...
     * @param $arabic_value
     */
    protected function validate_17($deadline_id, $english_value, $arabic_value) {
