 ...
 * Time: 04:50 م
 */
class Orm_Fp_Static_Service_Awards_Internal extends Orm_Fp_Static
{
    // 135 Award Name
    /**
     * draw the text for the input id = 135
     * @return object|string
     */
    protected function draw_135() {
     ...
     * @param $arabic_value
     */
    protected function validate_135($deadline_id, $english_value, $arabic_value) {
