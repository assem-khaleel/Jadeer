 ...
 * Time: 04:21 م
 */
class Orm_Fp_Static_Appointments_As_Editor extends Orm_Fp_Static
{
    // 1 Publication Name
    /**
     * draw the text for the input id = 1  "Publication Name"
     * @return object|string
     */
    protected function draw_1() {
     ...
     * @param $arabic_value
     */
    protected function validate_1($deadline_id, $english_value, $arabic_value) {
