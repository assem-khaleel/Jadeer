 ...
 * Time: 04:34 م
 */
class Orm_Fp_Static_University_Committees extends Orm_Fp_Static
{
    //18 Committee Name
    /**
     * draw the text for the input id = 18
     * @return object|string
     */
    protected function draw_18() {
     ...
     * @param $arabic_value
     */
    protected function validate_18($deadline_id, $english_value, $arabic_value) {
