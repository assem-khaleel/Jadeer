 ...
 * Time: 04:32 م
 */
class Orm_Fp_Static_Departmental_Committees extends Orm_Fp_Static
{
    //16 Committee Name
    /**
     * draw the text for the input id =16
     * @return object|string
     */
    protected function draw_16() {
     ...
     * @param $arabic_value
     */
    protected function validate_16($deadline_id, $english_value, $arabic_value) {
