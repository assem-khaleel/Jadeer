 ...
 * Time: 04:46 م
 */
class Orm_Fp_Static_Research_Awards_External extends Orm_Fp_Static
{
    // 132 Award Name
    /**
     * draw the text for the input id = 132
     * @return object|string
     */
    protected function draw_132() {
     ...
     * @param $arabic_value
     */
    protected function validate_132($deadline_id, $english_value, $arabic_value) {
