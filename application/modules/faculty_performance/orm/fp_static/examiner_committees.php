 ...
 * Time: 04:31 م
 */
class Orm_Fp_Static_Examiner_Committees extends Orm_Fp_Static
{
     //15 Committee Name
    /**
     * draw the text for the input id = 15
     * @return object|string
     */
    protected function draw_15() {
     ...
     * @param $arabic_value
     */
    protected function validate_15($deadline_id, $english_value, $arabic_value) {
