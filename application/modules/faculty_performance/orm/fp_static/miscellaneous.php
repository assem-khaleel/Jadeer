 ...
 * Time: 04:37 م
 */
class Orm_Fp_Static_Miscellaneous extends Orm_Fp_Static
{
    //123 Committee Name
    /**
     * draw the text for the input id = 123
     * @return object|string
     */
    protected function draw_123() {
     ...
     * @param $arabic_value
     */
    protected function validate_123($deadline_id, $english_value, $arabic_value) {
