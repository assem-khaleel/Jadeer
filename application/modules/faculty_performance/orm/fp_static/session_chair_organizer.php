 ...
 * Time: 04:24 م
 */
class Orm_Fp_Static_Session_Chair_Organizer extends Orm_Fp_Static
{
    //8 Chair Name
    /**
     * draw the text for the input id = 8
     * @return object|string
     */
    protected function draw_8() {
     ...
     * @param $arabic_value
     */
    protected function validate_8($deadline_id, $english_value, $arabic_value) {
