 ...
 * Time: 03:50 م
 */
class Orm_Fp_Static_Seminars_At_Other_Universities_Or_Industry extends Orm_Fp_Static
{
    // 83 Presentation Title
    /**
     * draw the text for the input id = 83
     * @return object|string
     */
    protected function draw_83() {
     ...
     * @param $arabic_value
     */
    protected function validate_83($deadline_id, $english_value, $arabic_value) {
    ...
    /**
     * draw the date for the input id = 85
     * @return object|string
     */
    protected function draw_85() {
     ...
     * @param $arabic_value
     */
    protected function validate_85($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
    ...
    // 86 Meeting or Conference

    /**
     * draw the text for the input id = 86
     * @return object|string
     */
    protected function draw_86() {
        return self::get_ci()->load->view('static/text',['static' => $this],true);
    }
     ...
     * @param $arabic_value
     */
    protected function validate_86($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
