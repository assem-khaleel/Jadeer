 ...
 * Time: 02:21 م
 */
class Orm_Fp_Static_Curricular_Revisions extends Orm_Fp_Static
{
    // 45 Semester
    /**
     ...
     * @return string
     */
    protected function get_input_45() {
        return Orm_Semester::get_instance($this->get_result()->get_input_value_en())->get_name();
    }

    /**
     * draw the semester selector for the input id = 45
     * @return object|string
     */
    protected function draw_45() {
     ...
     * @param $arabic_value
     */
    protected function validate_45($deadline_id, $english_value, $arabic_value) {
     ...
     * @return string
     */
    protected function get_input_47() {
        return Orm_Course::get_instance($this->get_result()->get_input_value_en())->get_name();

    }

    /**
     * draw the find_course selector for the input id = 47
     * @return object|string
     */
    protected function draw_47() {
     ...
     * @param $arabic_value
     */
    protected function validate_47($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
