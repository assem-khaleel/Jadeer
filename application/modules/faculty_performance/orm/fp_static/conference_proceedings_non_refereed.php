 ...
 * Time: 03:38 م
 */
class Orm_Fp_Static_Conference_Proceedings_Non_Refereed extends Orm_Fp_Static
{
    // 64 Name
    /**
     * draw the text for the input id = 64 "Name"
     * @return object|string
     */
    protected function draw_64() {
     ...
     * @param $arabic_value
     */
    protected function validate_64($deadline_id, $english_value, $arabic_value) {
    ...
    // 65 Appeared and Accepted

    /**
     * draw the text for the input id = 65  " Appeared and Accepted"
     * @return object|string
     */
    protected function draw_65() {
        return self::get_ci()->load->view('static/text',['static' => $this],true);
    }
     ...
     * @param $arabic_value
     */
    protected function validate_65($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
