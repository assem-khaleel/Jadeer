 ...
 * Time: 03:40 م
 */
class Orm_Fp_Static_Book_Chapters extends Orm_Fp_Static
{
    // 71 Chapter Title
    /**
     * draw the text for the input id = 71  "Chapter Title"
     * @return object|string
     */
    protected function draw_71() {
     ...
     * @param $arabic_value
     */
    protected function validate_71($deadline_id, $english_value, $arabic_value) {
    ...
    /**
     * draw the text for the input id = 72  "Book"
     * @return object|string
     */
    protected function draw_72() {
        return self::get_ci()->load->view('static/text',['static' => $this],true);
    }
     ...
     * @param $arabic_value
     */
    protected function validate_72($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
