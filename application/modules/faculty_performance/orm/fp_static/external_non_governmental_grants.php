 ...
 * Time: 04:12 م
 */
class Orm_Fp_Static_External_Non_Governmental_Grants extends Orm_Fp_Static
{
    // 99 Title
    /**
     * draw the text for the input id = 99
     * @return object|string
     */
    protected function draw_99() {
     ...
     * @param $arabic_value
     */
    protected function validate_99($deadline_id, $english_value, $arabic_value) {
    ...
    /**
     * draw the number for the input id = 104
     * @return object|string
     */
    protected function draw_104() {
     ...
     * @param $arabic_value
     */
    protected function validate_104($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
