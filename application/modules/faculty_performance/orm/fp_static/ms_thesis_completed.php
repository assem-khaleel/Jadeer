 ...
 * Time: 02:49 م
 */
class Orm_Fp_Static_Ms_Thesis_Completed extends Orm_Fp_Static
{
    // 20 Name
    /**
     * draw the text for the input id = 20
     * @return object|string
     */
    protected function draw_20() {
     ...
     * @param $arabic_value
     */
    protected function validate_20($deadline_id, $english_value, $arabic_value) {
     ...
     * @return string
     */
    protected function get_input_21() {
        return Orm_Degree::get_instance($this->get_result()->get_input_value_en())->get_name();

    }

    /**
     * draw the degree selector for the input id = 21
     * @return object|string
     */
    protected function draw_21() {
     ...
     * @param $arabic_value
     */
    protected function validate_21($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
    ...
    /**
     * draw the text for the input id = 22
     * @return object|string
     */
    protected function draw_22() {
        return self::get_ci()->load->view('static/text',['static' => $this],true);
    }
     ...
     * @param $arabic_value
     */
    protected function validate_22($deadline_id, $english_value, $arabic_value) {
        $this->refill($deadline_id, $english_value, $arabic_value);
