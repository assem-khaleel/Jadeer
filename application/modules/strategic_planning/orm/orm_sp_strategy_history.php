...
class Orm_Sp_Strategy_History extends Orm {
    
    /**
    * @var $instances Orm_Sp_Strategy_History[]
    */
    protected static $instances = array();
    protected static $table_name = 'sp_strategy_history';
    ...
    */
    ...
    /**
    * @return Sp_Strategy_History_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Sp_Strategy_History_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Sp_Strategy_History
    */
    ...
    * @param array $orders
    *
    * @return Orm_Sp_Strategy_History[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Sp_Strategy_History();
    }
