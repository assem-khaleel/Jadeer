...
class Orm_Sp_Project_History extends Orm {
    
    /**
    * @var $instances Orm_Sp_Project_History[]
    */
    protected static $instances = array();
    protected static $table_name = 'sp_project_history';
    ...
    */
    ...
    /**
    * @return Sp_Project_History_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Sp_Project_History_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Sp_Project_History[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Sp_Project_History();
    }
