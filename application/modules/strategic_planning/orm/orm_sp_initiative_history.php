...
class Orm_Sp_Initiative_History extends Orm {
    
    /**
    * @var $instances Orm_Sp_Initiative_History[]
    */
    protected static $instances = array();
    protected static $table_name = 'sp_initiative_history';
    ...
    */
    ...
    /**
    * @return Sp_Initiative_History_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Sp_Initiative_History_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Sp_Initiative_History
    */
    ...
    * @param array $orders
    *
    * @return Orm_Sp_Initiative_History[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Sp_Initiative_History();
    }
