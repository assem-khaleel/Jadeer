...
class Orm_Sp_Objective_Milestone extends Orm
{

    /**
     * @var $instances Orm_Sp_Objective_Milestone[]
     */
    protected static $instances = array();
    protected static $table_name = 'sp_objective_milestone';
    ...
    /**
     * @return Sp_Objective_Milestone_Model
     */
    public static function get_model()
    {
        return Orm::get_ci_model('Sp_Objective_Milestone_Model');
    }
     ...
     *
     * @param int $id
     * @return Orm_Sp_Objective_Milestone
     */
     ...
     * @param array $orders
     *
     * @return Orm_Sp_Objective_Milestone[] | int
     */
    ...
    public static function get_one($filters = array(), $orders = array())
    {
        ...
        return new Orm_Sp_Objective_Milestone();
    }
