...
class Orm_Sp_Objective_History extends Orm {
    
    /**
    * @var $instances Orm_Sp_Objective_History[]
    */
    protected static $instances = array();
    protected static $table_name = 'sp_objective_history';
    ...
    */
    ...
    /**
    * @return Sp_Objective_History_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Sp_Objective_History_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Sp_Objective_History
    */
    ...
    * @param array $orders
    *
    * @return Orm_Sp_Objective_History[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Sp_Objective_History();
    }
