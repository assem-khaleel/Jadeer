<?php
/* @var $milestone Orm_Sp_Initiative_Milestone */
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <?php
            if (!$milestone->get_id()) {
                echo lang('Create').' '.lang('Initiative Milestone');
            } else {
                echo lang('Edit').' '.lang('Initiative Milestone');
            }
            ?>
        </div>
...
<script>
    ...
    $('form#milestone-form').submit(function (e) {
        ...
        $.ajax({
            url: '/strategic_planning/initiative/milestone?id=<?php echo urlencode($initiative->get_id()) .'&strategy_id='. urlencode($strategy->get_id()); ?>',
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'JSON'
        }).done(function (msg) {
