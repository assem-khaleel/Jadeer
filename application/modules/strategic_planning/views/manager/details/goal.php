...
<script type="text/javascript">
    ...
    function show_goal() {
        ...
        $('#details-container').load('/strategic_planning/goal/details/?strategy_id=' + strategy_id + '&period_mode=' + period_mode + '&period_value=' + period_value + '&period_year=' + period_year, function () {
            init_data_toggle();
        });
