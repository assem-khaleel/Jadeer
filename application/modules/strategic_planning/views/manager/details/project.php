...
<script type="text/javascript">
    ...
    function show_projects() {
        ...
        $('#details-container').load('/strategic_planning/project/details?strategy_id=' + strategy_id + '&period_mode=' + period_mode + '&period_value=' + period_value + '&period_year=' + period_year, function () {
            init_data_toggle();
        });
