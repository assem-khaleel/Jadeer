...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <?php echo form_open("/award_management/save_old_winner", array('id' => 'winner-form')); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <input id="user_label_<?php echo $key ?>" type="text"
                                                   onclick="find_users(this,'user_id_<?php echo $key ?>','user_label_<?php echo $key ?>','',['Orm_User_Faculty','Orm_User_Staff','Orm_User_Student'],'<?php echo lang('Find winner'); ?>')"
                        ...
                        <div class="item m-y-1">
                            <div class="form-group m-a-0">
                                ...
                                <input id="user_label_0" type="text"
                                       onclick="find_users(this,'user_id_0','user_label_0','',['Orm_User_Faculty','Orm_User_Staff','Orm_User_Student'],'<?php echo lang('Find Winner'); ?>')"
                                       readonly
                                       class="form-control"/>
...
<script type="text/javascript">
    ...
    function add_user() {
        ...
        $('#more_users').append('<div class="item m-y-1">' +
            ...
            '<div class="row">' +
            '<div class="col-md-10">' +
            '<input id="user_label_' + count + '" type="text" onclick="find_users(this,\'user_id_' + count + '\',\'user_label_' + count + '\', \'\',[\'Orm_User_Faculty\',\'Orm_User_Staff\',\'Orm_User_Student\'],\'<?php echo lang('Find Winner'); ?>\')" readonly class="form-control"/>' +
