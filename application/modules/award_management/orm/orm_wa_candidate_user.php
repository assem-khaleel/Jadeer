...
class Orm_Wa_Candidate_User extends Orm {
    
    /**
    * @var $instances Orm_Wa_Candidate_User[]
    */
    protected static $instances = array();
    protected static $table_name = 'wa_candidate_user';
    ...
    */
    ...
    /**
    * @return Wa_Candidate_User_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Wa_Candidate_User_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Wa_Candidate_User[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Wa_Candidate_User();
    }
