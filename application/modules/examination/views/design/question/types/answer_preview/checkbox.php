<?php /* @var $question Orm_Tst_Question_Type_Checkbox */ ?>
<?php /* @var $attach   Orm_Tst_Exam_Response_Attachment */ ?>
                ...
                <?php foreach ($question->get_choices() as $choice): ?>
                    <div class="col-md-12">
                        <label class="custom-control custom-checkbox">
                            <input disabled="" type="checkbox" class="custom-control-input" <?php
                            if(isset($value)){
                                echo in_array($choice->get_id(), $value)? 'checked=""': '';
                            }
                            ?> />
