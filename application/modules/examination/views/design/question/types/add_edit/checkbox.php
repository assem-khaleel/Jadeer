    ...
    <div class="more_items" id="more">
        ...
        if ($choices) {
                ...
                <div class="item">
                    <div class="row">
                        <div class="form-group col-md-1 text-center">
                            <input name="choices[<?php echo $index ?>][correct]" type="checkbox" value=1 <?php echo (isset($choice['correct']) and $choice['correct'])? 'checked=""': '' ?> />
                        </div>
            ...
            <div class="item">
                <div class="row">
                    <div class="form-group col-md-1 text-center">
                        <input name="choices[0][correct]" type="checkbox" value=1>
                    </div>
                    <div class="form-group col-md-4">
...
<script type="text/javascript">
    function add_more() {
        ...
        $('#more').append('<div class="item">' +
            '<div class="row">' +
            '<div class="form-group col-md-1 text-center"><input name="choices[' + count + '][correct]" type="checkbox" value=1></div>' +
            '<div class="form-group col-md-4">' +
