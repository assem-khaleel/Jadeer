        ...
        <div class="table-responsive m-a-0">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td class="col-md-2"><?php echo lang('Attended'); ?></td>
                    <td class="col-md-2"><?php echo lang('Status'); ?></td>
                ...
                foreach ($students as $student): /* @var $student Orm_Course_Section_Student*/?>
                    <tr>
                        ...
                        <td><?php
                            $attended = Orm_Tst_Exam_Attendance::get_one(['exam_id' => $exam->get_id(), 'student_id'=>$student->get_user_id()]);

                            echo htmlfilter(($attended && $attended->get_id())? lang('Attended'): lang('Absent'));
                        ...
                        <td class="text-center">
                            <?php if($attended && $attended->get_id()):?>
                            <a href="<?php
