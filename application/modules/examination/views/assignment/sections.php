...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("/examination/assignments/section_manage/".($assignment->get_id()?: ''), array('id' => 'assignment_form')); ?>
        ...
        <div class="modal-body">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input id="course_label" type="text" readonly class="form-control" value="<?php echo htmlfilter($assignment->get_course_obj()->get_name()); ?>"/>
                </div>

                <div class="form-group">
                    <label class="control-label" for="sections"><?php echo lang('Course Sections'); ?></label>
                    <select name="sections[]" id="sections" multiple class="form-control">
                        <?php foreach (Orm_Course_Section::get_all(['course_id'=>$assignment->get_course_id(), 'semester_id'=>Orm_Semester::get_current_semester()->get_id()]) as $section){
                            $is_selected = false;
                            ?>
                            <?php foreach ($assignment->get_sections() as $sec) {
...
<script type="text/javascript">
    ...
    var find_onselect = function (course_id) {
        ...
        $.ajax({
            type: "GET",
            url: "/examination/assignment/get_section/" + course_id,
            dataType: 'json'
