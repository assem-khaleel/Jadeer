...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <?php echo form_open('/examination/assignments/save_question', 'id="question_form"') ?>
        <div class="modal-body">

            <div class="form-group">
                <label class="control-label"><?php echo lang('Question') ?></label>
                <input id="question_label" type="text" onclick="find_assignment_questions(this,'question_id','question_label', <?php echo Orm_Tst_Exam::get_instance($exam_id)->get_course_id() ?>)" readonly
        ...
        <div class="modal-footer">
            <input type="hidden" name="id" value="<?php echo $exam->get_id(); ?>">
...
<script>
    $('#question_form').submit(function (event) {
        ...
        $.ajax({
            url: '/examination/assignments/save_question',
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'JSON'
        }).done(function (msg) {
    ...
    function find_assignment_questions(element, property_id, property_label, course_id) {

        var url = (config.index_page ? '/' + config.index_page : '') + '/examination/assignments/find';
