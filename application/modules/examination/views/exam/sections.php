...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("/examination/section_manage/".($exam->get_id()?: ''), array('id' => 'exam_form')); ?>
        ...
        <div class="modal-body">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input id="course_label" type="text" readonly class="form-control" value="<?php echo htmlfilter($exam->get_course_obj()->get_name()); ?>"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="sections[]" id="sections" multiple class="form-control">
                        <?php foreach (Orm_Course_Section::get_all(['course_id'=>$exam->get_course_id(), 'semester_id'=>Orm_Semester::get_current_semester()->get_id()]) as $section){
                            $is_selected = false;

                            foreach ($exam->get_sections() as  $sec) {
