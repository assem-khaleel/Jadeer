...
?>
<form method="GET">
    <input type="hidden" id="question_id" name="question_id" value="<?php echo $this->input->get_post('question_id') ?>">
...
<script>
    function select_option(id) {
        ...
        parent.document.getElementById(question_id).value = option.val();
        parent.document.getElementById(property_label).value = option.attr('label');

        parent.find_onselect(option.val(), property_id, property_label,question_id);
