    ...
    <div class="panel panel-primary">
        <div class="panel-heading clearfix">
            ...
            <div  class="col-md-5 col-lg-5 text-right">
                <a class="btn btn-sm " <?php echo ($full_mark >= $quiz->get_fullmark())? 'disabled' : ('href="/examination/quiz/add_question/'.$quiz->get_id().'/'.$full_mark.' " data-toggle="ajaxModal"')?>>
        ...
        <div class="panel-body">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div  class="col-md-5 col-lg-5 text-right">
                        <a class="btn btn-sm" href="/examination/quiz/remove_question/<?php echo $question->get_id()?>/<?php echo $quiz->get_id()?>"  message="<?php echo lang('Are you sure ?') ?>" data-toggle="deleteAction" title="<?php echo lang('Delete').' '.lang('Question')?>">
