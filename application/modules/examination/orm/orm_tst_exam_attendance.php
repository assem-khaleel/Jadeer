...
class Orm_Tst_Exam_Attendance extends Orm {
    
    /**
    * @var $instances Orm_Tst_Exam_Attendance[]
    */
    protected static $instances = array();
    protected static $table_name = 'tst_exam_attendance';
    ...
    */
    ...
    /**
    * @return Tst_Exam_Attendance_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Tst_Exam_Attendance_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Tst_Exam_Attendance
    */
    ...
    * @param array $orders
    *
    * @return Orm_Tst_Exam_Attendance[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Tst_Exam_Attendance();
    }
