...
class Orm_Tst_Student_Attachment extends Orm {
    
    /**
    * @var $instances Orm_Tst_Student_Attachment[]
    */
    protected static $instances = array();
    protected static $table_name = 'tst_student_attachment';
    ...
    */
    ...
    /**
    * @return Tst_Student_Attachment_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Tst_Student_Attachment_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Tst_Student_Attachment
    */
    ...
    * @param array $orders
    *
    * @return Orm_Tst_Student_Attachment[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Tst_Student_Attachment();
    }
