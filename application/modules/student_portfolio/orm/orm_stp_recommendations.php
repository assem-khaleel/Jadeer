...
class Orm_Stp_Recommendations extends Orm {
    
    /**
    * @var $instances Orm_Stp_Recommendations[]
    */
    protected static $instances = array();
    protected static $table_name = 'stp_recommendations';
    ...
    */
    ...
    /**
    * @return Stp_Recommendations_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Stp_Recommendations_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Stp_Recommendations
    */
    ...
    * @param array $orders
    *
    * @return Orm_Stp_Recommendations[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Stp_Recommendations();
    }
    ...
    */
    ...
    public function set_added_by($value) {
        $this->add_object_field('added_by', $value);
        $this->added_by = $value;
    }
