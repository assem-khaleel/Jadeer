...
class Pc_Syllabus_Fields_Model extends CI_Model {
    ...
    */
    public function get_all($filters = array(), $page = 0, $per_page = 10, $orders = array(), $fetch_as = Orm::FETCH_OBJECTS) {
        ...
        $this->db->select('pt.*');
        $this->db->distinct();
        $this->db->from(Orm_Pc_Syllabus_Fields::get_table_name() . ' AS pt');
        ...
        if (isset($filters['required'])) {
            $this->db->where('pt.required', $filters['required']);
        }
        ...
        switch($fetch_as) {
            ...
            return Orm_Pc_Syllabus_Fields::to_object($this->db->get()->row_array());
            break;
            case Orm::FETCH_OBJECTS:
            $objects = array();
            foreach($this->db->get()->result_array() as $row) {
                $objects[] = Orm_Pc_Syllabus_Fields::to_object($row);
            }
            return $objects;
            break;
    ...
    */
    public function insert($params = array()) {
        $this->db->insert(Orm_Pc_Syllabus_Fields::get_table_name(), $params);
    ...
    */
    public function update($id, $params = array()) {
        return $this->db->update(Orm_Pc_Syllabus_Fields::get_table_name(), $params, array('id' => $id));
    }
    ...
    */
    public function delete($id) {
        return $this->db->delete(Orm_Pc_Syllabus_Fields::get_table_name(), array('id' => $id));
    }
