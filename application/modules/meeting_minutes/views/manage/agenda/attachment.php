...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("meeting_minutes/agenda_attachment/{$meeting->get_id()}", array('id' => 'agenda-attachment-form')); ?>
        <div class="modal-header">
            <span class="panel-title"><?php echo lang('Agenda Attachment'); ?></span>
        </div>
...
<script type="text/javascript">
    ...
    $('#agenda-attachment-form').on('submit', function (e) {
        e.preventDefault();
