...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("/meeting_minutes/save", array('id' => 'meeting-minutes-form')); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text"
                                       ...
                                       onclick="find_users(this, 'facilitator_id', 'facilitator_name', null, ['<?php echo Orm_User::USER_FACULTY . "', '" . Orm_User::USER_STAFF. "', '" . Orm_User::USER_STUDENT; ?>'])"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" disabled=""
                                       value="<?php echo lang(Orm_Mm_Meeting::get_type($meeting->get_type_class())) ?>">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select name="type_class" id="type_class" class="form-control">
                                ...
                                <?php foreach (Orm_Mm_Meeting::get_types() as $key => $type) { ?>
                                    <option <?php echo($meeting->get_type_class() == $type ? 'selected="selected"' : '')
                                    ?> value="<?php echo htmlfilter($type) ?>"><?php echo lang($key) ?>
                                    </option>
                                <?php } ?>
                            </select>
                            <?php echo Validator::get_html_error_message('type_class'); ?>
