...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("/survey/design/page_edit/{$page->get_id()}") ?>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><?php echo lang('Edit').' '.lang('Page'); ?></h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label"><?php echo lang('Title'); ?> (<?php echo lang('English') ?>)</label>
                    <input type="text" name="title_english" class="form-control"
                           value="<?php echo htmlfilter($page->get_title_english()) ?>"/>
                    <?php echo Validator::get_html_error_message('title_english'); ?>
                </div>

                <div class="form-group">
                    <label class="control-label"><?php echo lang('Title'); ?> (<?php echo lang('Arabic') ?>)</label>
                    <input type="text" name="title_arabic" class="form-control"
                           value="<?php echo htmlfilter($page->get_title_arabic()) ?>"/>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="description_english"
                              class="form-control description"><?php echo xssfilter($page->get_description_english()) ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="description_arabic"
                              class="form-control description"><?php echo xssfilter($page->get_description_arabic()) ?></textarea>
            ...
            <input type="hidden" name="survey_id" value="<?php echo htmlfilter($page->get_survey_id()); ?>"/>
        <?php echo form_close() ?>
    </div>
    <!-- /.modal-content -->
</div> <!-- /.modal-dialog -->
