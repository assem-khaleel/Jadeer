    ...
    <table class="table table-striped table-bordered">
        ...
        if ($programs) {
            ...
            foreach ($programs as $program) {
                ...
                $node = Orm_Node::get_one(array('system_number' => $active_node->get_system_number(), 'class_type' => Orm_Node::PROGRAM_PROGRAM, 'item_id' => $program->get_id()));
                ?>
                <tr>
                    <td>
...
//                                });
                    ...
                    <td class="text-center">
                        ...
                        <?php else : ?>
                            <a href="/accreditation/add_national/program/<?php echo (int)$program->get_id() ?>" class="btn btn-block"  role="button"
