    ...
    <table class="table table-striped table-bordered">
        ...
        if ($programs) {
            ...
            foreach ($programs as $program) {
                ...
                $node = Orm_Node::get_one(array('system_number' => $active_node->get_system_number(), 'class_type' => Orm_Node::PROGRAM_SSR, 'item_id' => $program->get_id()));
                ?>
                <tr>
                    <td>
...
//                                });
                    ...
                    <td class="text-center">
                        ...
                        <?php else : ?>
                            <a href="/accreditation/add_national/ssr/<?php echo intval($program->get_id()) ?>" class="btn btn-block"  role="button"  <?php echo data_loading_text() ?>
            ...
            <tr>
                <td colspan="10" style="text-align: center;">
                    <div class="well well-sm" style="margin: 0; padding: 10;">
