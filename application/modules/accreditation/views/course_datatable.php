    ...
    <table class="table table-striped table-bordered">
        ...
        if ($courses) {
            ...
            foreach ($courses as $course) {
                $node = Orm_Node::get_one(array('system_number' => $active_node->get_system_number(), 'class_type' => Orm_Node::COURSE_COURSE, 'item_id' => $course->get_id()));
                ?>
                <tr>
                    <td>
...
//                                });
                    ...
                    <td class="text-center">
                        ...
                        <?php else : ?>
                            <a href="/accreditation/add_national/course/<?php echo (int)$course->get_id(); ?>" class="btn btn-block" <?php echo data_loading_text() ?> onclick="$(this).button('loading');">
