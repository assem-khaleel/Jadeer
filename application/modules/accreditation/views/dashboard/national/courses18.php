...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <?php foreach ($courses as $plan) { ?>
            ...
            $node_course = Orm_Node::get_one(array('system_number' => $course2018_active_node->get_system_number(), 'class_type' => Orm_Node::COURSE_COURSE18, 'item_id' => $plan->get_course_id()));
            ?>
                            ...
                            <div class="widget-pricing-inner row p-x-1">
                                <?php foreach ($children_types as $class_type => $child_type) { ?>
                                    ...
                                    if($node_course->get_id()) {
                                        $node_types = Orm_Node::get_all(array('system_number' => $course2018_active_node->get_system_number(), 'class_type' => $class_type, 'parent_lft' => $node_course->get_parent_lft(), 'parent_rgt' => $node_course->get_parent_rgt()));
                                    }
