<?php
/* @var $course2018_active_node Node\ncacm18\Root */
...
<div class="panel panel-primary">
    ...
    <div class="panel-body p-b-0">
        ...
        foreach ($colleges as $college) {
            ...
            $ssr_node = Orm_Node::get_one(array('system_number' => $ssr2018_active_node->get_system_number(), 'class_type' => Orm_Node::COLLEGE_SSR18, 'item_id' => $college->get_id()));
            $program_node = Orm_Node::get_one(array('system_number' => $program2018_active_node->get_system_number(), 'class_type' => Orm_Node::COLLEGE_PROGRAM18, 'item_id' => $college->get_id()));
            ?>
                                ...
                                <div class="col-md-4">
                                    <div class="widget-pricing-item p-b-1 m-b-0">
                                        ...
                                        <div class="widget-pricing-section p-a-2 bg-white darker m-t-1">
                                            <div class="row">
                                                <div class="col-xs-6 col-md-12 col-lg-12 col-xl-6">
                                                    <div class="font-size-11"><?php echo $course2018_active_node->get_course_progress_bar(array('college_id' => $college->get_id()), 75) ?></div>
                                                    <div class="font-size-11 text-muted line-height-1"><?php echo lang('Progress'); ?></div>
                                                </div>
                                                <div class="col-xs-6 col-md-12 col-lg-12 col-xl-6 b-l-1">
                                                    <div class="font-size-11"><?php echo $course2018_active_node->get_course_review_bar(array('college_id' => $college->get_id()), 75) ?></div>
                                                    <div class="font-size-11 text-muted line-height-1"><?php echo lang('Review'); ?></div>
                                                </div>
                                            </div>
                                        </div>
