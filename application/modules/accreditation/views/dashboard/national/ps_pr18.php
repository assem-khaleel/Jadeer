...
$program_node = Orm_Node::get_one(array('system_number' => $program_active_node->get_system_number(), 'class_type' => Orm_Node::PROGRAM_PROGRAM18, 'item_id' => $program_id));
?>
    <div class="panel panel-primary">
        <div class="panel-heading"><?php echo lang('Program') . ' : ' . Orm_Program::get_instance($program_id)->get_name() ?></div>
        <div class="panel-body p-b-0">
            <?php foreach ($program_node->get_children() as $child) { ?>
