        ...
        <div class="panel-body">
            ...
            if ($course_section_count) { ?>
                ...
                <?php foreach (Orm_Course_Section::get_all($filters, $section_page, $per_page) as $section) { ?>
                    ...
                    $index = 0;
                    $node_section = Orm_Node::get_one(array('system_number' => $course2018_active_node->get_system_number(), 'class_type' => Orm_Node::COURSE_SECTION18, 'item_id' => $section->get_id()));
                    ?>
