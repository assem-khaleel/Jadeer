...
<div class="panel panel-primary">
    ...
    <div class="panel-body p-b-0">
        ...
        <?php foreach ($programs as $program) {
            $ssr_node = Orm_Node::get_one(array('system_number' => $ssr_active_node->get_system_number(), 'class_type' => Orm_Node::PROGRAM_SSR, 'item_id' => $program->get_id()));
            $program_node = Orm_Node::get_one(array('system_number' => $program_active_node->get_system_number(), 'class_type' => Orm_Node::PROGRAM_PROGRAM, 'item_id' => $program->get_id()));
            //$course_node = Orm_Node::get_one(array('system_number' => $course_active_node->get_system_number(), 'class_type' => Orm_Node::PROGRAM_COURSE, 'item_id' => $program->get_id()));
            ?>
                                ...
                                <div class="col-md-4">
                                    <div class="widget-pricing-item p-b-1 m-b-0">
                                        ...
                                        <div class="widget-pricing-section p-a-2 bg-white darker m-t-1">
                                            <div class="row">
                                                <div class="col-xs-6 col-md-12 col-lg-12 col-xl-6">
                                                    <div class="font-size-11"><?php echo $course_active_node->get_course_progress_bar(array('program_id' => $program->get_id()), 75) ?></div>
                                                    <div class="font-size-11 text-muted line-height-1"><?php echo lang('Progress'); ?></div>
                                                </div>
                                                <div class="col-xs-6 col-md-12 col-lg-12 col-xl-6 b-l-1">
                                                    <div class="font-size-11"><?php echo $course_active_node->get_course_review_bar(array('program_id' => $program->get_id()), 75) ?></div>
                                                    <div class="font-size-11 text-muted line-height-1"><?php echo lang('Review'); ?></div>
                                                </div>
                                            </div>
                                        </div>
