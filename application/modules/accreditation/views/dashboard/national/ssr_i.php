                        ...
                        <div class="page-forums-list-title box-cell col-md-7 col-lg-8 col-xl-9 p-r-4">
                            <div class="page-forum-topics-title font-size-14">
                                <?php if ($child->get_children()) { ?>
                                    <a data-toggle="ajaxRequest" data-target="container_<?php echo $node->get_indentation_level(); ?>" href="<?php echo handle_url(array('node_id' => $child->get_id(), 'type' => 'ssr-i')); ?>" class="font-weight-semibold" ><?php echo $child->get_name(); ?></a>
                                <?php } else { ?>
