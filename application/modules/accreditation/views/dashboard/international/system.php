...
if ($node->get_id()) {
    ...
    <div class="panel panel-primary">
        <div class="panel-heading"><?php echo $node->get_name(); ?></div>
        <div class="panel-body p-b-0">
            <?php foreach ($node->get_children() as $child) { ?>
                    ...
                    <div class="box-row">
                        <div class="page-forums-list-title box-cell col-md-7 col-lg-8 col-xl-9 p-r-4">
                            <div class="page-forum-topics-title font-size-14">
                                <?php if ($child->get_children()) { ?>
                                    <a data-toggle="ajaxRequest" data-target="container_<?php echo $node->get_indentation_level(); ?>" href="<?php echo handle_url(array('node_id' => $child->get_id(), 'type' => 'system')); ?>"><?php echo $child->get_name(); ?></a>
                                <?php } else { ?>
                            ...
                            <br>
                            <?php $assessors = $child->get_parent_assessors() + $child->get_assessors(); ?>
    ...
    <div id="container_<?php echo $node->get_indentation_level(); ?>"></div>
