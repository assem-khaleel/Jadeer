...
<?php if(Orm_Node::get_active_program_node()->get_id()) { ?>
    <div class="table-primary">
        <div class="table-header">
            <?php echo filter_block('/accreditation/national_program_filter', '/accreditation/national_program', [Orm_Campus::class, Orm_College::class, Orm_Department::class, Orm_Program::class,'keyword'],'ajax_block', draw_exclude($fltr)); ?>
        </div>
        <div id="ajax_block" >
            <?php $this->load->view('accreditation/program_datatable'); ?>
        </div>
    </div>
<?php } else { ?>
    <div class="well well-sm m-a-0">
        ...
        <?php if (Orm_Node::check_if_can_generate()) { ?>
            ...
            <div class="text-center" id="program-management-container">
                ...
                <?php echo form_hidden('system', Orm_Node::SYSTEM_PROGRAM); ?>
