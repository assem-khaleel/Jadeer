<?php
$recommendations = Orm_Acc_Pre_Visit_Reviewer_Recommendation::get_all(['type' => $type, 'type_id' => $type_id]);
?>
            ...
            <div class="box-row valign-middle">
                ...
                <div class="box-cell col-md-8">
                    ...
                    <div class="display-inline-block p-l-1 b-l-3 valign-middle font-size-12 text-muted">
                        <div>&ensp;</div>
                        <div><?php echo htmlfilter(Orm_Acc_Pre_Visit_Reviewer::get_type_element($type, $type_id)->get_name()) ?></div>
                        <div>&ensp;</div>
                    </div>
                </div>
