<?php
/** @var $pre_visit_reviewer Orm_Acc_Pre_Visit_Reviewer */
?>
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("/accreditation/reviewer_pre_visit/reviewer_add/{$visit_reviewer->get_type()}/{$visit_reviewer->get_type_id()}/{$visit_reviewer->get_id()}", 'id="reviewer_form"'); ?>
