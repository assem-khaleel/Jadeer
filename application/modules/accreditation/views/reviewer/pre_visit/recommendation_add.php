<?php
/** @var $visit_reviewer Orm_Acc_Pre_Visit_Reviewer */
/** @var $recommendation Orm_Acc_Pre_Visit_Reviewer_Recommendation */
?>
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("/accreditation/reviewer_pre_visit/recommendation_add_edit/{$visit_reviewer->get_type()}/{$visit_reviewer->get_type_id()}/{$recommendation->get_id()}", 'id="reviewer_form"'); ?>
