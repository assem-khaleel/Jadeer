 ...
 * @var $reviewers Orm_Acc_Visit_Reviewer */
?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="well m-a-0 p-a-1">
                            ...
                            <?php
                            $reviewers = array_column(Orm_Acc_Visit_Reviewer::get_model()->get_all(['type' => Orm_Acc_Visit_Reviewer::TYPE_PROGRAM, 'type_id' => $program->get_id()], 0,0,[],Orm::FETCH_ARRAY), 'reviewer_id');
                            ?>
                    ...
                    <td class="text-center">
                        <?php if($is_admin) { ?>
                            <a class="btn btn-sm btn-block" href="/accreditation/reviewer_visit/reviewer_list/program/<?php echo intval($program->get_id()); ?>">
                                <span class="btn-label-icon left"><i class="fa fa-list"></i></span>
                                <?php echo lang('Reviewers'); ?>
                            </a>
                        <?php } ?>
                        <a class="btn btn-sm btn-block" href="/accreditation/reviewer_visit/recommendation_list/program/<?php echo intval($program->get_id()); ?>">
                            <span class="btn-label-icon left"><i class="fa fa-list"></i></span>
                            <?php echo lang('Recommendations'); ?>
                        </a>
                        <a class="btn btn-sm btn-block" href="/accreditation/reviewer_visit/report/program/<?php echo urlencode($program->get_id()); ?>">
                            <span class="btn-label-icon left"><i class="fa fa-flag"></i></span> <?php echo lang('Report'); ?>
                        </a>
                        <a class="btn btn-sm btn-block" href="/accreditation/reviewer_visit/report/program/<?php echo urlencode($program->get_id()); ?>/1" >
