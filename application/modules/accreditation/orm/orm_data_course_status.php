...
class Orm_Data_Course_Status extends Orm {
    
    /**
    * @var $instances Orm_Data_Course_Status[]
    */
    protected static $instances = array();
    protected static $table_name = 'data_course_status';
    ...
    */
    ...
    /**
    * @return Data_Course_Status_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Data_Course_Status_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Data_Course_Status[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Data_Course_Status();
    }
    ...
    */
    ...
    public function get_status_obj() {
        return Orm_Data_Course_Statuses::get_instance($this->get_status_id());
    }
}
