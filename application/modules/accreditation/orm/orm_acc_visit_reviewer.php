...
class Orm_Acc_Visit_Reviewer extends Orm {
    
    /**
    * @var $instances Orm_Acc_Visit_Reviewer[]
    */
    protected static $instances = array();
    protected static $table_name = 'acc_visit_reviewer';
    ...
    */
    ...
    /**
    * @return Acc_Visit_Reviewer_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Acc_Visit_Reviewer_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Acc_Visit_Reviewer[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Acc_Visit_Reviewer();
    }
