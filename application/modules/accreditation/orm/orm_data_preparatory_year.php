...
class Orm_Data_Preparatory_Year extends Orm {
    
    /**
    * @var $instances Orm_Data_Preparatory_Year[]
    */
    protected static $instances = array();
    protected static $table_name = 'data_preparatory_year';
    ...
    */
    ...
    protected $completion_count = 0;
    
    /**
    * @return Data_Preparatory_Year_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Data_Preparatory_Year_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Data_Preparatory_Year
    */
    ...
    * @param array $orders
    *
    * @return Orm_Data_Preparatory_Year[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Data_Preparatory_Year();
    }
    ...
    */
    ...
    public function to_array() {
        ...
        $db_params['completion_count'] = $this->get_completion_count();
    ...
    public function set_completion_count($value) {
        $this->add_object_field('completion_count',$value);
        $this->completion_count = $value;
    }

    public function get_completion_count() {
        return $this->completion_count;
    }

    public static function get_by_year($year) {
        return self::get_model()->get_by_year($year);
    }
}
