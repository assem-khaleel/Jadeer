...
class Orm_Data_Course_Grade extends Orm {
    
    /**
    * @var $instances Orm_Data_Course_Grade[]
    */
    protected static $instances = array();
    protected static $table_name = 'data_course_grade';
    ...
    */
    ...
    /**
    * @return Data_Course_Grade_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Data_Course_Grade_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Data_Course_Grade[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Data_Course_Grade();
    }
