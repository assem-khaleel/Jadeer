...
class Orm_Acc_Pre_Visit_Reviewer_Recommendation extends Orm {
    
    /**
    * @var $instances Orm_Acc_Pre_Visit_Reviewer_Recommendation[]
    */
    protected static $instances = array();
    protected static $table_name = 'acc_pre_visit_reviewer_recommendation';
    ...
    */
    ...
    /**
    * @return Acc_Pre_Visit_Reviewer_Recommendation_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Acc_Pre_Visit_Reviewer_Recommendation_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Acc_Pre_Visit_Reviewer_Recommendation
    */
    ...
    * @param array $orders
    *
    * @return Orm_Acc_Pre_Visit_Reviewer_Recommendation[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Acc_Pre_Visit_Reviewer_Recommendation();
    }
    ...
    */
    ...
    public function get_visit_reviewer_obj() {
        return Orm_Acc_Pre_Visit_Reviewer::get_instance($this->get_visit_reviewer_id());
    }
    ...
    public function get_action_plans() {
        ...
        if(is_null($this->action_plans)) {
            $this->action_plans = Orm_Acc_Pre_Visit_Reviewer_Action_Plan::get_all(['recommendation_id' => $this->get_id()]);
        }
