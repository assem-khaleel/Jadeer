...
class Criterion_6 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('faculty_workload', '<b>B. Faculty Workload</b> <br/>Complete Table 6-2, Faculty Workload Summary and describe this information in terms of workload expectations or requirements for the current academic year.');
