...
class Appendix_D extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('institution', '<b>1. The Institution</b>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('type_of_control', '<b>2. Type of Control</b>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('educational_unit', '<b>3. Educational Unit</b>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('academic_support', '<b>4. Academic Support Units</b>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('nonacademic_support', '<b>5. Non-academic Support Units</b>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('credit_unit', '<b>6. Credit Unit</b>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('tables', '<b>7. Tables</b> <br/>Complete the following tables for the program undergoing evaluation.');
