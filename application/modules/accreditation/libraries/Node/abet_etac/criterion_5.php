...
class Criterion_5 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('program_curriculum', '<b>A. Program Curriculum</b>');
    ...
    public function set_curriculum_table_overall($value)
    {
        ...
        $property->add_cell(1, 1, new \Orm_Property_Fixedtext('credit_hour', 'Curricular Area (Credit Hours)'), 0, 4);
    ...
    public function set_curriculum_table_note()
    {
        $property = new \Orm_Property_Fixedtext('curriculum_table_note', '<ol type= "1">'
            . '<li>For courses that include multiple elements (lecture, laboratory, recitation, etc.), indicate the average enrollment in each element.</li>'
    ...
    public function set_culminating_experience($value)
    {
        ...
        $property->set_description('6. If your program has a capstone or other culminating experience for students specifically addressed by either the general or program criteria, describe how this experience helps students attain the student outcomes.');
        $property->set_group('group_a');
        $this->set_property($property);
    }
    ...
    public function set_example($value)
    {
        ...
        $property->set_description('8. Describe by example how the evaluation team will be able to relate the display materials, i.e. course syllabi, textbooks, sample student work, etc., to each student outcome.  (See the 2015-2016 APPM section II.G.6.b.(2) regarding display materials.)');
        $property->set_group('group_a');
        $this->set_property($property);
    }
    ...
    {
        $property = new \Orm_Property_Fixedtext('course_syllabi', '<b>B. Course Syllabi</b> <br/>'
    ...
    public function set_advisory()
    {
        $property = new \Orm_Property_Fixedtext('advisory', '<b>C. Advisory Committee</b>');
    ...
    {
        return $this->get_property('advisory')->get_value();
    }

    public function set_advisory_committee($value)
    {
        $property = new \Orm_Property_Textarea('advisory_committee', $value);
        $property->set_description('Describe the composition of the program’s advisory committee and show that it is representative of organizations being served by the program’s graduates.  Describe activities of the advisory committee and provide evidence that it is assisting the program to (1) review the curriculum and (2) maintain the validity of the program educational objectives.');
        $property->set_group('group_c');
        $this->set_property($property);
    }
    ...
    {
        return $this->get_property('advisory_committee')->get_value();
    }
