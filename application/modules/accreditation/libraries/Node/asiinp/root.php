...
class Root extends \Orm_Node
{
    ...
    protected $name = 'ASIIN Programmatic V.2014';
    ...
    public function get_children_nodes()
    {
        ...
        $childrens = array();
        $childrens[] = new Asiinp_1_General();
        $childrens[] = new Asiinp_2_Requirements();
        $childrens[] = new Asiinp_3_Procedures();
        $childrens[] = new Asiinp_4_Basis();
        $childrens[] = new Asiinp_5_Appendix();
