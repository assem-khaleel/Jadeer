...
class Root extends \Orm_Node
{
    ...
    protected $name = 'Program Specifications and Reports V.2015';
    public $college_id;
    public $program_id;
    ...
    public function add_college($name, $item_id = 0, $assessor_ids = array())
    {
        ...
        $node_obj = self::get_one(array('class_type' => self::COLLEGE_PROGRAM, 'item_id' => $item_id, 'system_number' => $this->get_system_number()));
    ...
    public function system_validator(&$view_params = array())
    {
        ...
        $node = self::get_active_program_node();
        $node18 = self::get_active_program2018_node();
