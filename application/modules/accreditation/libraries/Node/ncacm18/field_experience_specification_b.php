...
class Field_Experience_Specification_B extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('note', ' <br/><strong>Learning Outcomes for Field Experience in Domains of Learning, Assessment Methods and Teaching Strategy</strong> <br/> <br/>'
