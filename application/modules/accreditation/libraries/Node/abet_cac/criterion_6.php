...
class Criterion_6 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('faculty_workload', '<strong>B. Faculty Workload</strong> <br/>Complete Table 6-2, Faculty Workload Summary and describe this information in terms of workload expectations or requirements (for the year of the Self Study)');
    ...
    public function set_faculty_size_discussion($value)
    {
        ...
        $property->set_description('Discuss how the faculty serving in the program are of sufficient number to maintain continuity, stability, oversight, student interaction, and advising for the program');
        $property->set_group('group_c');
        $this->set_property($property);
    }
