...
class Criterion_2 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('mission', '<strong>A. Mission Statement</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('program_educational', '<strong>B. Program Educational Objectives</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('program_consistence', '<strong>C. Consistency of the Program Educational Objectives with the Mission of the Institution</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('program_constituencies', '<strong>D. Program Constituencies</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('process', '<strong>E. Process for Review of the Program Educational Objectives</strong>');
