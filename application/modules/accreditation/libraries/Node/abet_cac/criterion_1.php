...
class Criterion_1 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('student', '<strong>A. Student Admissions</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('evaluation', '<strong>B. Evaluating Student Performance</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('transfer', '<strong>C. Transfer Students and Transfer Courses</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('advising', '<strong>D. Advising and Career Guidance</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('courses', '<strong>E. Work in Lieu of Courses</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('graduation', '<strong>F. Graduation Requirements</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('transcripts', '<strong>G. Transcripts of Recent Graduates</strong>');
