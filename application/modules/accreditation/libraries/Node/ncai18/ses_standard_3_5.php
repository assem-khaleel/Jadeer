...
class Ses_Standard_3_5 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('info', '<strong>Evaluations of performance must be based on evidence (including but not restricted to predetermined performance indicators and benchmarks) and conclusions based on that evidence must be independently verified.</strong><br/><br/>The level of compliance with this standard is judged by the extent to which the following good practices are followed.');
    ...
    public function set_3_5_1($value)
    {
        ...
        $property->set_description('3.5.1 Self-evaluations of quality of performance are based on several related sources of evidence  including feedback through user surveys and opinions of stakeholders such as students and teaching staff, graduates and employers.');
        $this->set_property($property);
    }
    ...
    public function set_3_5_3($value)
    {
        ...
        $property->set_description('3.5.3 Institutional policies and procedures have been established for the verification of standards of achievement by students in relation to other institutions and the requirements of the National Qualifications Framework.');
        $this->set_property($property);
    }
