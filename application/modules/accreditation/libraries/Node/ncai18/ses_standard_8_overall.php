...
/**
 * Description of Ses_Standard_8_Overall
 *
 * @author user
 */
class Ses_Standard_8_Overall extends \Orm_Node
{

    protected $class_type = __CLASS__;
    protected $name = 'Overall Assessment of Financial Planning and Management';
    ...
    {
        $property = new \Orm_Property_Smart_Field('8_1', $value);
        $property->set_class('Node\ncai18\Ses_Standard_8_1');
    ...
    {
        $property = new \Orm_Property_Smart_Field('8_2', $value);
        $property->set_class('Node\ncai18\Ses_Standard_8_2');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_system_obj()->get_system_number());
        $property->add_filter('parent_lft', $this->get_system_obj()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_system_obj()->get_parent_rgt());
    ...
    {
        $property = new \Orm_Property_Smart_Field('8_3', $value);
        $property->set_class('Node\ncai18\Ses_Standard_8_3');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_system_obj()->get_system_number());
        $property->add_filter('parent_lft', $this->get_system_obj()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_system_obj()->get_parent_rgt());
        $property->set_description('8.3 Auditing and Risk assessment');
        $this->set_property($property);
    }
    ...
    public function set_combined_assessment($value)
    {
        ...
        $property->set_equation('([8_1]+[8_2]+[8_3])/3');
    ...
    public function integration_processes() {
        ...
        if(\License::get_instance()->check_module('kpi') && \Modules::load('kpi')) {
            $standard = \Orm_Standard::get_one(['code' => 8]);
