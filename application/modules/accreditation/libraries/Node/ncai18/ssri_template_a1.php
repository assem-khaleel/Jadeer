...
/**
 * Description of Ssri_Template_A1
 *
 * @author ahmadgx
 */
class Ssri_Template_A1 extends \Orm_Node
{

    protected $class_type = __CLASS__;
    protected $name = 'Periodic Institutional Profile Template A1';
    ...
    public function get_children_nodes()
    {
        ...
        foreach (\Orm_College::get_all() as $college) {
            $node = new Ssri_Template_A1_Program_Data();
            $node->set_name($college->get_name('english') . ' (Programs Data)');
