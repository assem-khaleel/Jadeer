...
class Ssri_H_Independent_Evaluations extends \Orm_Node
{
    ...
    public function init()
    {
        ...
        $this->set_process_description('');
        $this->set_recommendation_list('');
        $this->set_response_report('');
        $this->set_evaluation_report('');
    }

    public function set_process_description($value)
    {
        $property = new \Orm_Property_Textarea('process_description', $value);
    ...
    public function get_process_description()
    {
        return $this->get_property('process_description')->get_value();
    }
