...
class kpi extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Text('internal', $value);
    ...
    {
        $property = new \Orm_Property_Text('external', $value);
    ...
    {
        $property = new \Orm_Property_Fixedtext('explain', '<b>* Explain:</b>');
        $this->set_property($property);
    }
    ...
    {
        $property = new \Orm_Property_Fixedtext('explain_2', '<b>** Explain:</b>');
        $this->set_property($property);
    }
