...
class Ssri_B_Institutional_Pro extends \Orm_Node
{
    ...
    public function set_history_of_institution($value)
    {
        ...
        $property->set_description("1. A brief summary of the institution’s history, brief description of branch campuses/ locations, total number of colleges, programs, institutes, research units /research chair /research centers, medical hospitals and centers, plus descriptions of scale and range of activities");
        $this->set_property($property);
    }
    ...
    public function set_institution_accreditation($value)
    {
        ...
        $property->set_description("3. Summary information about the institution’s accreditation status including the outcomes of any previous institutional reviews, and any conditions that were established");
        $this->set_property($property);
    }
    ...
    public function set_institution_quality($value)
    {
        ...
        $property->set_description("4. A description of the institution’s quality assurance arrangements, priorities for development, and any special issues affecting its operations");
        $this->set_property($property);
    }
    ...
    public function set_institution_strategic_plan($value)
    {
        ...
        $property->set_description("5. A summary of the institution's strategic plan (a copy of the actual strategic plan should be available)");
        $this->set_property($property);
    }
