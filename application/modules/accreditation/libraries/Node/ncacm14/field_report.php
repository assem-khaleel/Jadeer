...
namespace Node\ncacm14;
use Node\ncacm14\Field_Experience_Sp_Signature;
/**
 * Description of Field_Report
 *
 * @author user
 */
class Field_Report extends \Orm_Node
{
    ...
    public function set_info()
    {
        $property = new \Orm_Property_Fixedtext('info', '<div style="border: 1px solid black; padding: 6px;">To be completed by the faculty or teaching staff member at the end of each field experience.</div> <br/>'
            . '<strong>Field Experience Report</strong> <br/>Field Experience encompasses fieldwork, professional or clinical placements, internships and other forms of placement learning and applied learning that are part of the formal curriculum within the educational program. For direction on the completion of this template, refer NCAAA guidebooks.');
