...
/**
 * Description of course_report_signature
 *
 * @author ahmadgx
 */
class Course_Report_Signature extends \Orm_Node {
    ...
    public function set_signatures($value) {
        ...
        $instructor = new \Orm_Property_Fixedtext('instructor_name', 'Name of Course Instructor: ');
        $instructor->set_width(162);
