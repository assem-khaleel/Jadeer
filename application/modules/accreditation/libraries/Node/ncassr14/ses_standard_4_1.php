...
/**
 * Description of ses_standard_4_1
 *
 * @author ahmadgx
 */
class Ses_Standard_4_1 extends \Orm_Node
{
    ...
    protected $name = '4.1 Student Learning Outcomes';
    ...
    public function set_4_1_1($value)
    {
        ...
        $property->set_description('4.1.1 Intended learning outcomes are specified after consideration of relevant academic and professional advice.');
        $this->set_property($property);
    }
    ...
    public function set_4_1_2($value)
    {
        ...
        $property->set_description('4.1.2 Intended learning outcomes are consistent with the Qualifications Framework. (covering all of the domains of learning at the standards required)');
        $this->set_property($property);
    }
    ...
    public function set_4_1_4($value)
    {
        ...
        $property->set_description('4.1.4 If an institution has identified special attributes to be developed in students graduating from the institution comprehensive strategies are established for these to be developed.  (This means that the attributes to be developed in students are clearly defined, strategies for developing them planned and implemented across the program, and mechanisms for assessing and reporting on the extent to which graduating students have developed them, are in place.)');
        $this->set_property($property);
    }
    ...
    public function set_4_1_5($value)
    {
        ...
        $property->set_description('4.1.5 Appropriate program evaluation mechanisms including graduating student surveys, employment outcome data, employer feedback and subsequent performance of graduates are used to provide evidence about the appropriateness of intended learning outcomes and the extent to which they are achieved.  (see also sections 4.3 and 4.4 dealing with program evaluation processes and verification of standards of student achievement)');
        $this->set_property($property);
    }
