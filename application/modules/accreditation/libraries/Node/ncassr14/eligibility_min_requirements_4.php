...
class Eligibility_Min_Requirements_4 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('info', 'A clear description of the institution’s processes for program approval, monitoring program quality, and approval of program changes.');
