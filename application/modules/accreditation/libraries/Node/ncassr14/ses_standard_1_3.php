...
class Ses_Standard_1_3 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('info', '<strong>The mission must be developed through consultative processes and formally adopted and periodically reviewed.</strong>'
    ...
    public function set_1_3_1($value)
    {
        ...
        $property->set_description('1.3.1 Major stakeholders associated with the program have been consulted and support the mission.');
        $this->set_property($property);
    }
    ...
    public function set_1_3_2($value)
    {
        ...
        $property->set_description('1.3.2 The decision making body responsible for approving the program within the institution formally approved the mission statement.');
        $this->set_property($property);
    }
    ...
    public function set_1_3_3($value)
    {
        ...
        $property->set_description('1.3.3 The mission statement is periodically reaffirmed or amended if necessary in the light of changing circumstances.');
        $this->set_property($property);
    }
    ...
    public function set_1_3_4($value)
    {
        ...
        $property->set_description('1.3.4 Stakeholders are kept informed about the mission and any changes made to it.');
        $this->set_property($property);
    }
