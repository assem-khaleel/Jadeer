...
class Ssr extends \Orm_Node
{
    ...
    public function set_introduction()
    {
        $property = new \Orm_Property_Fixedtext('introduction', '<strong>Introductory Comments</strong> <br/> <br/>'
            ...
            . '<strong>The Self Study Report for Programs template is for an Undergraduate Program. </strong>For guidance on the completion of this template, please refer to the<i> Handbook for Quality Assurance and Accreditation and to the Guidelines for Using the Template for a Program Self-Study.</i>');
