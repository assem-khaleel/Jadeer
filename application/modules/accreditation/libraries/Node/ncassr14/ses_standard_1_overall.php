...
/**
 * Description of ses_standard_1_overall
 *
 * @author ahmadgx
 */
class Ses_Standard_1_Overall extends \Orm_Node
{

    protected $class_type = __CLASS__;
    protected $name = 'Overall Assessment of Mission Goals and Objectives';
    ...
    {
        $property = new \Orm_Property_Smart_Field('1_1', $value);
        $property->set_class('Node\ncassr14\Ses_Standard_1_1');
    ...
    {
        $property = new \Orm_Property_Smart_Field('1_2', $value);
        $property->set_class('Node\ncassr14\Ses_Standard_1_2');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
    ...
    {
        $property = new \Orm_Property_Smart_Field('1_3', $value);
        $property->set_class('Node\ncassr14\Ses_Standard_1_3');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('1.3 Processes of Development and Review of the Mission');
        $this->set_property($property);
    }
    ...
    {
        $property = new \Orm_Property_Smart_Field('1_4', $value);
        $property->set_class('Node\ncassr14\Ses_Standard_1_4');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('1.4 Use Made of Mission Statement');
        $this->set_property($property);
    }
    ...
    {
        $property = new \Orm_Property_Smart_Field('1_5', $value);
        $property->set_class('Node\ncassr14\Ses_Standard_1_5');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
    ...
    public function set_combined_assessment($value)
    {
        ...
        $property->set_equation('([1_1]+[1_2]+[1_3]+[1_4]+[1_5])/5');
    ...
    public function integration_processes() {
        ...
        if(\License::get_instance()->check_module('kpi') && \Modules::load('kpi')) {
            $standard = \Orm_Standard::get_one(['code' => 1]);
