...
class Ssri_G_Evaluation extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('introduction', "<strong>The main branch/location campus must complete the entire SSRI together with the required information from all branch/location campuses.</strong> <br/> <br/>"
