...
class Ses_Standard_7_3 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('info', '<strong>Management and administration of facilities, equipment and associated services must be efficient and ensure maximum effective utilization of facilities provided.</strong><br/><br/>The level of compliance with this standard is judged by the extent to which the following good practices are followed.');
    ...
    public function set_7_3_1($value)
    {
        ...
        $property->set_description('7.3.1 A complete inventory is maintained of equipment owned or controlled by the institution including equipment assigned to individual staff for teaching and research.');
        $this->set_property($property);
    }
    ...
    public function set_7_3_2($value)
    {
        ...
        $property->set_description('7.3.2 Services such as cleaning, waste disposal, minor maintenance, safety, and environmental management are efficiently and effectively carried out under the supervision of a senior administrative officer.');
        $this->set_property($property);
    }
    ...
    public function set_7_3_5($value)
    {
        ...
        $property->set_description('7.3.5 Effective systems are in place to ensure the personal security of teaching or other staff and students, with appropriate provisions for the security of their personal property.');
        $this->set_property($property);
    }
    ...
    public function set_7_3_6($value)
    {
        ...
        $property->set_description('7.3.6 Space utilization is monitored and facilities reallocated in response to changing requirements.');
        $this->set_property($property);
    }
    ...
    public function set_7_3_7($value)
    {
        $property = new \Orm_Property_Rank_Applicable('7_3_7', $value);
        $property->set_description('7.3.7 Scheduling of general-purpose facilities is managed through an electronic booking and reservation system, and the extent and efficiency of use is monitored and reported.');
        $this->set_property($property);
    }

    public function get_7_3_7()
    {
        return $this->get_property('7_3_7')->get_value();
    }

    public function set_7_3_8($value)
    {
        $property = new \Orm_Property_Rank_Applicable('7_3_8', $value);
        $property->set_description('7.3.8 Arrangements are made for shared use of underutilized facilities with adequate mechanisms for security of equipment.');
        $this->set_property($property);
    }

    public function get_7_3_8()
    {
        return $this->get_property('7_3_8')->get_value();
    }
    ...
    public function set_overall_assessment($value)
    {
        ...
        $property->add_property_name('7_3_7');
        $property->add_property_name('7_3_8');
        $this->set_property($property);
    }
