...
class Ssri_G_Evaluation_9_Employment_Processes extends \Orm_Node
{
    ...
    public function set_quality_mission($value)
    {
        ...
        $property->set_description('Overall Evaluation of Quality Standard 9.  Refer to evidence obtained and provide a report based on that evidence; including a list of particular strengths, recommendations for improvement, and priorities for action');
        $this->set_property($property);
    }
