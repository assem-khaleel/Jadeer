...
/**
 * Description of Ses_Standard_10_Overall
 *
 * @author user
 */
class Ses_Standard_10_Overall extends \Orm_Node
{

    protected $class_type = __CLASS__;
    protected $name = 'Overall Assessment of Research';
    ...
    {
        $property = new \Orm_Property_Smart_Field('10_1', $value);
        $property->set_class('Node\ncai14\Ses_Standard_10_1');
    ...
    {
        $property = new \Orm_Property_Smart_Field('10_2', $value);
        $property->set_class('Node\ncai14\Ses_Standard_10_2');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_system_obj()->get_system_number());
        $property->add_filter('parent_lft', $this->get_system_obj()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_system_obj()->get_parent_rgt());
        $property->set_description('10.2 Teaching Staff and Student Involvement');
        $this->set_property($property);
    }
    ...
    {
        $property = new \Orm_Property_Smart_Field('10_3', $value);
        $property->set_class('Node\ncai14\Ses_Standard_10_3');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_system_obj()->get_system_number());
        $property->add_filter('parent_lft', $this->get_system_obj()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_system_obj()->get_parent_rgt());
    ...
    {
        $property = new \Orm_Property_Smart_Field('10_4', $value);
        $property->set_class('Node\ncai14\Ses_Standard_10_4');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_system_obj()->get_system_number());
        $property->add_filter('parent_lft', $this->get_system_obj()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_system_obj()->get_parent_rgt());
        $property->set_description('10.4 Research Facilities and Equipment');
        $this->set_property($property);
    }
    ...
    public function set_combined_assessment($value)
    {
        ...
        $property->set_equation('([10_1]+[10_2]+[10_3]+[10_4])/4');
    ...
    public function integration_processes() {
        ...
        if(\License::get_instance()->check_module('kpi') && \Modules::load('kpi')) {
            $standard = \Orm_Standard::get_one(['code' => 10]);
