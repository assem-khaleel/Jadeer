...
class Criterion_4 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('info', 'This section of your Self-Study Report should document your processes for regularly assessing and evaluating the extent to which the student outcomes are being attained.  This section should also document the extent to which the student outcomes are being attained. It should also describe how the results of these processes are utilized to affect continuous improvement of the program. <br/> <br/>'
    ...
    {
        $property = new \Orm_Property_Fixedtext('student_outcomes', '<b>A. Student Outcomes</b>'
    ...
    {
        $property = new \Orm_Property_Fixedtext('improvement', '<b>B. Continuous Improvement</b>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('information', '<b>C. Additional Information</b>');
