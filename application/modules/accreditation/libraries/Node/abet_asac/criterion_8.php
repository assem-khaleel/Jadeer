...
class Criterion_8 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('leader', '<strong>A. Leadership</strong>');
    ...
    {
        $property = new \ Orm_Property_Fixedtext('program_budget', '<strong>B. Program Budget and Financial Support</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('staffing', '<strong>C. Staffing</strong>');
    ...
    {
        $property = new \ Orm_Property_Fixedtext('faculty_hiring', '<strong>D. Faculty Hiring and Retention</strong>');
    ...
    {
        $property = new \ Orm_Property_Fixedtext('faculty_development', '<strong>E. Support of Faculty Professional Development</strong>');
