...
class Appendix_A extends \Orm_Node
{
    ...
    public function set_course_syllabi()
    {
        $property = new \Orm_Property_Fixedtext('course_syllabi', 'Please use the following format for the course syllabi (2 pages maximum in Times New Roman 12 point font)'
            ...
            . '<ol type="a">'
            . '<li> other supplemental materials</li>'
            . '</ol>'
            . '</li>'
            . '<li>Specific course information'
            . '<ol type="a">'
            . '<li>brief description of the content of the course (catalog description)</li>'
            . '<li>prerequisites or co-requisites</li>'
            . '<li>indicate whether a required, elective, or selected elective (as per Table 5-1) course in the program</li>'
            . '</ol>'
            . '</li>'
            . '<li>Specific goals for the course'
            . '<ol type="a">'
            . '<li>specific outcomes of instruction, ex. The student will be able to explain the significance of current research about a particular topic.</li>'
            . '<li>explicitly indicate which of the student outcomes listed in Criterion 3 or any other outcomes are addressed by the course.</li>'
            . '</ol>'
            . '</li>'
