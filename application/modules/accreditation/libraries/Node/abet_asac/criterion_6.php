...
class Criterion_6 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('faculty', '<strong>A. Faculty Qualifications</strong> <br/>'
    ...
    public function set_faculty_qualifications($value)
    {
        ...
        $practice->set_description('Govt./Ind. Practice');
        $practice->set_group('Years of Experience');
        $practice->set_width(200);
        $property->add_property($practice);

        $institution = new \Orm_Property_Text('institution');
        $institution->set_description('This Institution');
        $institution->set_group('Years of Experience');
    ...
    {
        $property = new \Orm_Property_Fixedtext('faculty_workload', '<strong>B. Faculty Workload</strong> <br/>Complete Table 6-2, Faculty Workload Summary and describe this information in terms of workload expectations or requirements for the current academic year.');
    ...
    {
        $property = new \Orm_Property_Fixedtext('faculty_size', '<strong>C. Faculty Size</strong>');
    ...
    public function set_faculty_size_discussion($value)
    {
        ...
        $property->set_description('Discuss the adequacy of the size of the faculty and describe the extent and quality of faculty involvement in interactions with students, student advising, and oversight of the program.');
        $property->set_group('group_c');
        $this->set_property($property);
    }
    ...
    {
        $property = new \Orm_Property_Fixedtext('professional_development', '<strong>D. Professional Development</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('authority', '<strong>E. Authority and Responsibility of Faculty</strong>');
