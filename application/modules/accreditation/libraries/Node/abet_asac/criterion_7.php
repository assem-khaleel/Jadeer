...
class Criterion_7 extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Fixedtext('offices', '<strong>A. Offices, Classrooms and Laboratories</strong> <br/>Summarize each of the program’s facilities in terms of their ability to support the attainment of the student outcomes and to provide an atmosphere conducive to learning.');
    ...
    {
        $property = new \Orm_Property_Fixedtext('computing', '<strong>B. Computing Resources</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('guidance', '<strong>C. Guidance</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('maintenance', '<strong>D. Maintenance and Upgrading of Facilities</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('library_services', '<strong>E. Library Services</strong>');
    ...
    {
        $property = new \Orm_Property_Fixedtext('overall', '<strong>F. Overall Comments on Facilities</strong>');
