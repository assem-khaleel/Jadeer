...
class Background_Info extends \Orm_Node
{
    ...
    {
        $property = new \Orm_Property_Textarea('options', $value);
    ...
    {
        return $this->get_property('options')->get_value();
    }
    ...
    public function get_program_delivery()
    {
        return $this->get_property('program_delivery')->get_value();
    }
