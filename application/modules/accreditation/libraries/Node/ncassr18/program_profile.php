...
class Program_Profile extends \Orm_Node
{
    ...
    public function set_table_7($value)
    {
        ...
        $master_programs_two_year_2 = new \Orm_Property_Text('master_programs_two_year_2');
        $master_programs_two_year_2->set_width(100);
        $master_programs_two_year_3 = new \Orm_Property_Text('master_programs_two_year_3');
        $master_programs_two_year_3->set_width(100);
        $master_programs_two_year_4 = new \Orm_Property_Text('master_programs_two_year_4');
        $master_programs_two_year_4->set_width(100);
        $master_programs_three_year_3 = new \Orm_Property_Text('master_programs_three_year_3');
        $master_programs_three_year_3->set_width(100);
        $master_programs_three_year_4 = new \Orm_Property_Text('master_programs_three_year_4');
        $master_programs_three_year_4->set_width(100);
        $master_programs_three_year_5 = new \Orm_Property_Text('master_programs_three_year_5');
        $master_programs_three_year_5->set_width(100);
        $master_programs_four_year_4 = new \Orm_Property_Text('master_programs_four_year_4');
        $master_programs_four_year_4->set_width(100);
        $master_programs_four_year_5 = new \Orm_Property_Text('master_programs_four_year_5');
        $master_programs_four_year_5->set_width(100);
        $master_programs_four_year_6 = new \Orm_Property_Text('master_programs_four_year_6');
        $master_programs_four_year_6->set_width(100);
        
        $doctoral_programs_three_year_3 = new \Orm_Property_Text('doctoral_programs_three_year_3');
        $doctoral_programs_three_year_3->set_width(100);
        $doctoral_programs_three_year_4 = new \Orm_Property_Text('doctoral_programs_three_year_4');
        $doctoral_programs_three_year_4->set_width(100);
        $doctoral_programs_three_year_5 = new \Orm_Property_Text('doctoral_programs_three_year_5');
        $doctoral_programs_three_year_5->set_width(100);
        $doctoral_programs_four_year_4 = new \Orm_Property_Text('doctoral_programs_four_year_4');
        $doctoral_programs_four_year_4->set_width(100);
        $doctoral_programs_four_year_5 = new \Orm_Property_Text('doctoral_programs_four_year_5');
        $doctoral_programs_four_year_5->set_width(100);
        $doctoral_programs_four_year_6 = new \Orm_Property_Text('doctoral_programs_four_year_6');
        $doctoral_programs_four_year_6->set_width(100);
        $doctoral_programs_five_year_5 = new \Orm_Property_Text('doctoral_programs_five_year_5');
        $doctoral_programs_five_year_5->set_width(100);
        $doctoral_programs_five_year_6 = new \Orm_Property_Text('doctoral_programs_five_year_6');
        $doctoral_programs_five_year_6->set_width(100);
        $doctoral_programs_five_year_7 = new \Orm_Property_Text('doctoral_programs_five_year_7');
        $doctoral_programs_five_year_7->set_width(100);
        ...
        $property->add_cell(1, 3, new \Orm_Property_Fixedtext('master_programs', 'Master Programs'), 0, 9);
        $property->add_cell(1, 4, new \Orm_Property_Fixedtext('doctor_programs', 'Doctoral Programs'), 0, 9);
        ...
        $property->add_cell(2, 4, new \Orm_Property_Fixedtext('master_programs_two_years', 'Two-Year Program'),0,3);
        $property->add_cell(2, 5, new \Orm_Property_Fixedtext('master_programs_three_years', 'Three-Year Program'),0,3);
        $property->add_cell(2, 6, new \Orm_Property_Fixedtext('master_programs_four_years', 'Four-Year Program'),0,3);
        $property->add_cell(2, 7, new \Orm_Property_Fixedtext('doctor_programs_three_years', 'Three-Year Program'),0,3);
        $property->add_cell(2, 8, new \Orm_Property_Fixedtext('doctor_programs_four_years', 'Four-Year Program'),0,3);
        $property->add_cell(2, 9, new \Orm_Property_Fixedtext('doctor_programs_five_years', 'Five-Year Program'),0,3);
        ...
        $property->add_cell(3, 10, new \Orm_Property_Fixedtext('master_two_years_2', '2'));
        $property->add_cell(3, 11, new \Orm_Property_Fixedtext('master_two_years_3', '3'));
        $property->add_cell(3, 12, new \Orm_Property_Fixedtext('master_two_years_4', '4'));

        $property->add_cell(3, 13, new \Orm_Property_Fixedtext('master_two_years_3', '3'));
        $property->add_cell(3, 14, new \Orm_Property_Fixedtext('master_two_years_4', '4'));
        $property->add_cell(3, 15, new \Orm_Property_Fixedtext('master_two_years_5', '5'));

        $property->add_cell(3, 16, new \Orm_Property_Fixedtext('master_two_years_4', '4'));
        $property->add_cell(3, 17, new \Orm_Property_Fixedtext('master_two_years_5', '5'));
        $property->add_cell(3, 18, new \Orm_Property_Fixedtext('master_two_years_6', '6'));

        $property->add_cell(3, 19, new \Orm_Property_Fixedtext('doctor_three_years_3', '3'));
        $property->add_cell(3, 20, new \Orm_Property_Fixedtext('doctor_three_years_4', '4'));
        $property->add_cell(3, 21, new \Orm_Property_Fixedtext('doctor_three_years_5', '5'));

        $property->add_cell(3, 22, new \Orm_Property_Fixedtext('doctor_three_years_4', '4'));
        $property->add_cell(3, 23, new \Orm_Property_Fixedtext('doctor_three_years_5', '5'));
        $property->add_cell(3, 24, new \Orm_Property_Fixedtext('doctor_three_years_6', '6'));

        $property->add_cell(3, 25, new \Orm_Property_Fixedtext('doctor_three_years_5', '5'));
        $property->add_cell(3, 26, new \Orm_Property_Fixedtext('doctor_three_years_6', '6'));
        $property->add_cell(3, 27, new \Orm_Property_Fixedtext('doctor_three_years_7', '7'));
        ...
        $property->add_cell(4, 11, $master_programs_two_year_2);
        $property->add_cell(4, 12, $master_programs_two_year_3);
        $property->add_cell(4, 13, $master_programs_two_year_4);

        $property->add_cell(4, 14, $master_programs_three_year_3);
        $property->add_cell(4, 15, $master_programs_three_year_4);
        $property->add_cell(4, 16, $master_programs_three_year_5);

        $property->add_cell(4, 17, $master_programs_four_year_4);
        $property->add_cell(4, 18, $master_programs_four_year_5);
        $property->add_cell(4, 19, $master_programs_four_year_6);

        $property->add_cell(4, 20, $doctoral_programs_three_year_3);
        $property->add_cell(4, 21, $doctoral_programs_three_year_4);
        $property->add_cell(4, 22, $doctoral_programs_three_year_5);

        $property->add_cell(4, 23, $doctoral_programs_four_year_4);
        $property->add_cell(4, 24, $doctoral_programs_four_year_5);
        $property->add_cell(4, 25, $doctoral_programs_four_year_6);

        $property->add_cell(4, 26, $doctoral_programs_five_year_5);
        $property->add_cell(4, 27, $doctoral_programs_five_year_6);
        $property->add_cell(4, 28, $doctoral_programs_five_year_7);
...
;
        ...
        $property->add_cell(5, 11, $master_programs_two_year_2);
        $property->add_cell(5, 12, $master_programs_two_year_3);
        $property->add_cell(5, 13, $master_programs_two_year_4);

        $property->add_cell(5, 14, $master_programs_three_year_3);
        $property->add_cell(5, 15, $master_programs_three_year_4);
        $property->add_cell(5, 16, $master_programs_three_year_5);

        $property->add_cell(5, 17, $master_programs_four_year_4);
        $property->add_cell(5, 18, $master_programs_four_year_5);
        $property->add_cell(5, 19, $master_programs_four_year_6);

        $property->add_cell(5, 20, $doctoral_programs_three_year_3);
        $property->add_cell(5, 21, $doctoral_programs_three_year_4);
        $property->add_cell(5, 22, $doctoral_programs_three_year_5);

        $property->add_cell(5, 23, $doctoral_programs_four_year_4);
        $property->add_cell(5, 24, $doctoral_programs_four_year_5);
        $property->add_cell(5, 25, $doctoral_programs_four_year_6);

        $property->add_cell(5, 26, $doctoral_programs_five_year_5);
        $property->add_cell(5, 27, $doctoral_programs_five_year_6);
        $property->add_cell(5, 28, $doctoral_programs_five_year_7);
        ...
        $property->add_cell(6, 11, $master_programs_two_year_2);
        $property->add_cell(6, 12, $master_programs_two_year_3);
        $property->add_cell(6, 13, $master_programs_two_year_4);

        $property->add_cell(6, 14, $master_programs_three_year_3);
        $property->add_cell(6, 15, $master_programs_three_year_4);
        $property->add_cell(6, 16, $master_programs_three_year_5);

        $property->add_cell(6, 17, $master_programs_four_year_4);
        $property->add_cell(6, 18, $master_programs_four_year_5);
        $property->add_cell(6, 19, $master_programs_four_year_6);

        $property->add_cell(6, 20, $doctoral_programs_three_year_3);
        $property->add_cell(6, 21, $doctoral_programs_three_year_4);
        $property->add_cell(6, 22, $doctoral_programs_three_year_5);

        $property->add_cell(6, 23, $doctoral_programs_four_year_4);
        $property->add_cell(6, 24, $doctoral_programs_four_year_5);
        $property->add_cell(6, 25, $doctoral_programs_four_year_6);

        $property->add_cell(6, 26, $doctoral_programs_five_year_5);
        $property->add_cell(6, 27, $doctoral_programs_five_year_6);
        $property->add_cell(6, 28, $doctoral_programs_five_year_7);
        ...
        if (!is_null($program_node) && $program_node->get_id()) {
            ...
            if (\Orm::get_ci()->config->item('integration_enabled')) {
                ...
                if (!is_null($program_node) && $program_node->get_id()) {
                    ...
                    $bsc_ids =  array_column(\Orm_Program::get_model()->get_all(array('department_id' => $program_obj->get_department_id(),'degree_status' => \Orm_Degree::DEGREE_UNDERGRAUDATE_BACHELOR),0,0,array(),\Orm::FETCH_ARRAY),'id');
                    $diploma_ids =  array_column(\Orm_Program::get_model()->get_all(array('department_id' => $program_obj->get_department_id(),'degree_status' => \Orm_Degree::DEGREE_UNDERGRAUDATE_DIPLOMA),0,0,array(),\Orm::FETCH_ARRAY),'id');
                    $higher_diploma_ids =  array_column(\Orm_Program::get_model()->get_all(array('department_id' => $program_obj->get_department_id(),'degree_status' => \Orm_Degree::DEGREE_POSTGRAUDATE_HIGH_DIPLOMA),0,0,array(),\Orm::FETCH_ARRAY),'id');
                    $masters_ids =  array_column(\Orm_Program::get_model()->get_all(array('department_id' => $program_obj->get_department_id(),'degree_status' =>  \Orm_Degree::DEGREE_POSTGRAUDATE_MASTER),0,0,array(),\Orm::FETCH_ARRAY),'id');
                    $phd_ids =  array_column(\Orm_Program::get_model()->get_all(array('department_id' => $program_obj->get_department_id(),'degree_status' => \Orm_Degree::DEGREE_POSTGRAUDATE_DOCTOR),0,0,array(),\Orm::FETCH_ARRAY),'id');
                    ...
                    $table_7[4][11]['master_programs_two_year_2'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 2,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][12]['master_programs_two_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 3,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][13]['master_programs_two_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][14]['master_programs_three_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 3,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][15]['master_programs_three_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][16]['master_programs_three_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][17]['master_programs_four_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][18]['master_programs_four_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][19]['master_programs_four_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 6,'gender' => \Orm_User::GENDER_MALE));

                    $table_7[4][20]['phd_programs_three_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 3,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][21]['phd_programs_three_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][22]['phd_programs_three_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][23]['phd_programs_four_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][24]['phd_programs_four_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][25]['phd_programs_four_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 6,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][26]['phd_programs_five_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][27]['phd_programs_five_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 6,'gender' => \Orm_User::GENDER_MALE));
                    $table_7[4][28]['phd_programs_five_year_7'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 7,'gender' => \Orm_User::GENDER_MALE));
                    ...
                    $table_7[5][11]['master_programs_two_year_2'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 2,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][12]['master_programs_two_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 3,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][13]['master_programs_two_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][14]['master_programs_three_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 3,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][15]['master_programs_three_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][16]['master_programs_three_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][17]['master_programs_four_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][18]['master_programs_four_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][19]['master_programs_four_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 6,'gender' => \Orm_User::GENDER_FEMALE));

                    $table_7[5][20]['phd_programs_three_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 3,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][21]['phd_programs_three_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][22]['phd_programs_three_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][23]['phd_programs_four_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 4,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][24]['phd_programs_four_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][25]['phd_programs_four_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 6,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][26]['phd_programs_five_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][27]['phd_programs_five_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 6,'gender' => \Orm_User::GENDER_FEMALE));
                    $table_7[5][28]['phd_programs_five_year_7'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 7,'gender' => \Orm_User::GENDER_FEMALE));
...
//                    $table_7[5][12]['postgraduate_programs_phd_completion_rate'] = 0;
                    ...
                    $table_7[6][11]['master_programs_two_year_2'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 2));
                    $table_7[6][12]['master_programs_two_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 3));
                    $table_7[6][13]['master_programs_two_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $two_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4));
                    $table_7[6][14]['master_programs_three_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 3));
                    $table_7[6][15]['master_programs_three_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4));
                    $table_7[6][16]['master_programs_three_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 5));
                    $table_7[6][17]['master_programs_four_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 4));
                    $table_7[6][18]['master_programs_four_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 5));
                    $table_7[6][19]['master_programs_four_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_master_programs,'academic_year' => $this->get_year(),'number_of_years' => 6));

                    $table_7[6][20]['phd_programs_three_year_3'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 3));
                    $table_7[6][21]['phd_programs_three_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 4));
                    $table_7[6][22]['phd_programs_three_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $three_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5));
                    $table_7[6][23]['phd_programs_four_year_4'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 4));
                    $table_7[6][24]['phd_programs_four_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5));
                    $table_7[6][25]['phd_programs_four_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $four_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 6));
                    $table_7[6][26]['phd_programs_five_year_5'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 5));
                    $table_7[6][27]['phd_programs_five_year_6'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 6));
                    $table_7[6][28]['phd_programs_five_year_7'] = \Orm_Data_Competion_Rate::get_sum(array('program_in' => $five_phd_programs,'academic_year' => $this->get_year(),'number_of_years' => 7));
