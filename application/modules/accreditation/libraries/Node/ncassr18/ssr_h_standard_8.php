...
class Ssr_H_Standard_8 extends \Orm_Node
{
    ...
    public function set_overall_rating($value)
    {
        ...
        $property->set_class('Node\ncassr18\Ses_Standard_8_Overall');
    ...
    public function set_explanatory_report($value)
    {
        ...
        $property->set_description('Provide an explanatory report about financial planning and management activities for the following sub-standards');
        $this->set_property($property);
    }
    ...
    public function set_evaluation_report($value)
    {
        ...
        $property->set_description('Evaluation of financial planning and management processes for the program.  Refer to evidence about the standard and sub-standards within it and provide a report including a list of strengths, recommendations for improvement, and priorities for action');
        $this->set_property($property);
    }
