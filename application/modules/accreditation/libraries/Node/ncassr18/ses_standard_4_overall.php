...
class Ses_Standard_4_Overall extends \Orm_Node
{
    ...
    public function set_4_1($value)
    {
        ...
        $property->set_description('4.1 Student Learning Outcomes');
    ...
    public function set_4_2($value)
    {
        ...
        $property->set_class('Node\ncassr18\Ses_Standard_4_2');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.2 Program Development Processes');
        $this->set_property($property);
    }
    ...
    public function set_4_3($value)
    {
        ...
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.3 Program Evaluation and Review Processes');
        $this->set_property($property);
    }
    ...
    public function set_4_4($value)
    {
        ...
        $property->set_class('Node\ncassr18\Ses_Standard_4_4');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.4 Student Assessment');
        $this->set_property($property);
    }
    ...
    public function set_4_5($value)
    {
        ...
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.5 Educational Assistance for Students');
        $this->set_property($property);
    }
    ...
    public function set_4_6($value)
    {
        ...
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.6 Quality of Teaching');
        $this->set_property($property);
    }
    ...
    public function set_4_7($value)
    {
        ...
        $property->set_class('Node\ncassr18\Ses_Standard_4_7');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.7 Support for Improvements in Teaching');
        $this->set_property($property);
    }
    ...
    public function set_4_8($value)
    {
        ...
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.8 Qualifications and Experience of Faculty');
        $this->set_property($property);
    }
    ...
    public function set_4_9($value)
    {
        ...
        $property->set_class('Node\ncassr18\Ses_Standard_4_9');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.9 Field Experience Activities');
        $this->set_property($property);
    }
    ...
    public function set_4_10($value)
    {
        ...
        $property->set_class('Node\ncassr18\Ses_Standard_4_10');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('4.10 Partnership Arrangements With Other Institutions');
        $this->set_property($property);
    }
    ...
    public function set_combined_assessment($value)
    {
        ...
        $property->set_equation('([4_1]+[4_2]+[4_3]+[4_4]+[4_5]+[4_6]+[4_7]+[4_8]+[4_9]+[4_10])/10');
        $this->set_property($property);
    }
