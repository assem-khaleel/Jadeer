...
/**
 * Description of ses_standard_7_overall
 *
 * @author ahmadgx
 */
class Ses_Standard_7_Overall extends \Orm_Node
{

    protected $class_type = __CLASS__;
    protected $name = 'Overall Assessment of Facilities and Equipment';
    ...
    {
        $property = new \Orm_Property_Smart_Field('7_1', $value);
        $property->set_class('Node\ncassr18\Ses_Standard_7_1');
    ...
    {
        $property = new \Orm_Property_Smart_Field('7_2', $value);
        $property->set_class('Node\ncassr18\Ses_Standard_7_2');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
        $property->set_description('7.2 Quality of and Adequacy of Facilities');
        $this->set_property($property);
    }
    ...
    {
        $property = new \Orm_Property_Smart_Field('7_3', $value);
        $property->set_class('Node\ncassr18\Ses_Standard_7_3');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
    ...
    {
        $property = new \Orm_Property_Smart_Field('7_4', $value);
        $property->set_class('Node\ncassr18\Ses_Standard_7_4');
        $property->set_function('get_overall_assessment');
        $property->add_filter('system_number', $this->get_parent_program_node()->get_system_number());
        $property->add_filter('parent_lft', $this->get_parent_program_node()->get_parent_lft());
        $property->add_filter('parent_rgt', $this->get_parent_program_node()->get_parent_rgt());
    ...
    public function set_combined_assessment($value)
    {
        ...
        $property->set_equation('([7_1]+[7_2]+[7_3]+[7_4])/4');
        $this->set_property($property);
    }
    ...
    public function integration_processes() {
        ...
        if(\License::get_instance()->check_module('kpi') && \Modules::load('kpi')) {
            $standard = \Orm_Standard::get_one(['code' => 7]);
