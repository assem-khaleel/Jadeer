...
/**
 * Description of ssr_h_standard_4_10
 *
 * @author ahmadgx
 */
class Ssr_H_Standard_4_10 extends \Orm_Node
{

    protected $class_type = __CLASS__;
    protected $name = 'Subsection 4.10 Partnership Arrangements With Other Institutions';
    ...
    public function set_process($value)
    {
        ...
        $property->set_description('If partnerships have been established with other institutions to assist with the planning and or delivery of the program, describe what is done through those partnerships and explain what has been done to evaluate the effectiveness of those activities.');
        $this->set_property($property);
    }
    ...
    public function set_evaluation_report($value)
    {
        ...
        $property->set_description('Evaluation of partnership arrangements (if any).  Refer to evidence and provide a report including a list of strengths, recommendations for improvement, and priorities for action.');
        $this->set_property($property);
    }
