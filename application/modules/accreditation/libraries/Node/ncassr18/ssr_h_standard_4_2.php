...
/**
 * Description of ssr_h_standard_4_2
 *
 * @author ahmadgx
 */
class Ssr_H_Standard_4_2 extends \Orm_Node
{

    protected $class_type = __CLASS__;
    protected $name = 'Subsection 4.2 Program Development Processes';
    ...
    public function set_process($value)
    {
        ...
        $property->set_description('Describe the processes followed for developing the program and implementing changes that might be needed. ');
        $this->set_property($property);
    }
    ...
    public function set_evaluation_report($value)
    {
        ...
        $property->set_description('Evaluation of program development processes.  Refer to evidence and provide a report including a list of strengths, recommendations for improvement, and priorities for action.');
        $this->set_property($property);
    }
