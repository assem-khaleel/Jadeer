<?php
/** @var $outcomes Orm_Cm_Course_Learning_Outcome[] */
/** @var int $course_id */
/** @var Orm_Cm_Learning_Domain $domain */
?>
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <?php echo form_open("/curriculum_mapping/course/learning_outcome_target/{$course_id}/{$domain->get_id()}" , array('id' => 'course-form')); ?>
