...
foreach (Orm_Cm_Course_Learning_Outcome_Survey::get_all(array('course_id' => Orm_Course_Section::get_instance($section_id)->get_course_id())) as $item) {
...
foreach ($clo as $c) {
    ...
    foreach (Orm_Cm_Course_Learning_Outcome_Survey::get_all(array('course_learning_outcome_id' => $c)) as $factor) {
        ...
        $filters['course_id'] = Orm_Course_Section::get_instance($section_id)->get_course_id();
    ...
    $text = str_replace('\'', '\\\'', htmlfilter($clo_obj->get_text()));
        ...
        <div class="panel box">
            <div class="box-row">
                <div class="box-cell p-x-3 p-y-1">
                    <div class="pull-xs-left font-weight-semibold font-size-12"><?php echo lang('Course Learning Outcomes'); ?></div>
                </div>
            </div>
            <div class="box-row">
...
<script type="text/javascript">
    ...
    if (typeof google.visualization === 'undefined') {
        ...
        google.setOnLoadCallback(drawSectionCLOs);
    } else {
        drawSectionCLOs();
    }

    function drawSectionCLOs() {
        ...
        var chart = new google.visualization.BarChart(document.getElementById('section-scores'));
