...
$program_id = Orm_User::get_logged_user()->get_program_id();

$domains_target = Orm_Cm_Program_Learning_Outcome_Target::get_domain_target(0, $program_id);
    ...
    function drawBasic_<?php echo $uniqid?>() {
        ...
        function selectHandler() {
            ...
            if (selectedItem && selectedItem.row != null) {
                ...
                ajaxRender('colleges','/curriculum_mapping/reporting/outcomes?type=courses&program_id=<?php echo $program_id; ?>&domain_id='+value);
            }
        }
