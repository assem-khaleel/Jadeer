...
foreach ($programs as $key => $program) {
    $json[] = "['". htmlfilter(Orm_Program::get_instance($program['program_id'])->get_name()) ."', " . number_format($program['score'],2) . "," . number_format($program['score'],2) . ", " . $program['program_id']  . ", '". Orm_Cm_Section_Student_Assessment::$GOOGLE_COLORS[$key%20] ."']";
}
    ...
    function drawColleges() {
        ...
        function selectHandler() {
            ...
            if (selectedItem && selectedItem.row != null) {
                ...
                ajaxRender('courses','/curriculum_mapping/reporting/assessment_methods?type=courses&program_id='+value+'&method_id=<?php echo $method_id; ?>');
            }
        }

        var chart = new google.visualization.BarChart(
            document.getElementById('programs-method'));
