...
foreach ($courses as $key => $course) {
    $json[] = "['". htmlfilter(Orm_Course::get_instance($course['course_id'])->get_name()) ."', " . number_format($course['score'],2) . "," . number_format($course['score'],2) . ", " . $course['course_id'] . ", '". Orm_Cm_Section_Student_Assessment::$GOOGLE_COLORS[$key%20] ."']";
}
    ...
    function drawColleges() {
        ...
        function selectHandler() {
            ...
            if (selectedItem && selectedItem.row != null) {
                ...
                ajaxRender('sections','/curriculum_mapping/reporting/assessment_methods?type=sections&course_id='+value+'&method_id=<?php echo $method_id; ?>');
            }
        }

        var chart = new google.visualization.BarChart(
            document.getElementById('courses-method'));
