...
foreach ($sections as $key => $section) {
    $json[] = "['". htmlfilter(Orm_Course_Section::get_instance($section['section_id'])->get_name()) ."', " . number_format($section['score'],2) . "," . number_format($section['score'],2) . ", " . $section['section_id'] . ", '". Orm_Cm_Section_Student_Assessment::$GOOGLE_COLORS[$key%20] ."']";
}
    ...
    function drawColleges() {
        ...
        function selectHandler() {
            ...
            if (selectedItem && selectedItem.row != null) {
                ...
                ajaxRender('students','/curriculum_mapping/reporting/assessment_methods?type=students&section_id='+value+'&method_id=<?php echo $method_id; ?>');
            }
        }

        var chart = new google.visualization.BarChart(
            document.getElementById('sections-method'));
