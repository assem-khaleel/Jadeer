...
class Orm_Cm_Program_Assessment_Component_Log extends Orm {
    
    protected static $table_name = 'cm_program_assessment_component_log';
    
    /**
    * @var $instances Orm_Cm_Program_Assessment_Component_Log[]
    */
    ...
    */
    ...
    protected $log_assessment_component_id = 0;
    protected $log_text_en = '';
    protected $log_text_ar = '';
    
    /**
    * @return Cm_Program_Assessment_Component_Log_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Program_Assessment_Component_Log_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Cm_Program_Assessment_Component_Log
    */
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Program_Assessment_Component_Log[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Program_Assessment_Component_Log();
    }
    ...
    */
    ...
    public function to_array() {
        ...
        $db_params['log_assessment_component_id'] = $this->get_log_assessment_component_id();
    ...
    public function set_log_assessment_component_id($value) {
        $this->add_object_field('log_assessment_component_id', $value);
        $this->log_assessment_component_id = $value;
    }
    
    public function get_log_assessment_component_id() {
        return $this->log_assessment_component_id;
    }
