...
class Orm_Cm_Program_X_Matrix_Method_Log extends Orm {
    
    /**
    * @var $instances Orm_Cm_Program_X_Matrix_Method_Log[]
    */
    protected static $instances = array();
    protected static $table_name = 'cm_program_x_matrix_method_log';
    ...
    */
    ...
    protected $log_assessment_method_id = 0;
    protected $log_program_learning_outcome_id = 0;
    protected $semester_id = 0;
    protected $log_id = 0;
    protected $log_value = 0;

    /**
    * @return Cm_Program_X_Matrix_Method_Log_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Program_X_Matrix_Method_Log_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Cm_Program_X_Matrix_Method_Log
    */
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Program_X_Matrix_Method_Log[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Program_X_Matrix_Method_Log();
    }
    ...
    */
    ...
    public function to_array() {
        ...
        $db_params['log_assessment_method_id'] = $this->get_log_assessment_method_id();
        ...
        $db_params['log_value'] = $this->get_log_value();
    ...
    public function set_log_assessment_method_id($value) {
        $this->add_object_field('log_assessment_method_id', $value);
        $this->log_assessment_method_id = $value;
    }
    
    public function get_log_assessment_method_id() {
        return $this->log_assessment_method_id;
    }
    ...
    public function set_log_value($value) {
        $this->add_object_field('log_value', $value);
