...
class Orm_Cm_Program_Learning_Outcome_Survey extends Orm {
    
    /**
    * @var $instances Orm_Cm_Program_Learning_Outcome_Survey[]
    */
    protected static $instances = array();
    protected static $table_name = 'cm_program_learning_outcome_survey';
    ...
    */
    ...
    /**
    * @return Cm_Program_Learning_Outcome_Survey_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Program_Learning_Outcome_Survey_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Cm_Program_Learning_Outcome_Survey
    */
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Program_Learning_Outcome_Survey[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Program_Learning_Outcome_Survey();
    }
