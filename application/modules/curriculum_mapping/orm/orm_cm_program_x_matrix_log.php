...
class Orm_Cm_Program_X_Matrix_Log extends Orm {
    
    /**
    * @var $instances Orm_Cm_Program_X_Matrix_Log[]
    */
    protected static $instances = array();
    protected static $table_name = 'cm_program_x_matrix_log';
    ...
    */
    ...
    protected $log_xmatrix = 0;
    protected $semester_id = 0;
    protected $log_id = 0;
    
    /**
    * @return Cm_Program_X_Matrix_Log_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Program_X_Matrix_Log_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Cm_Program_X_Matrix_Log
    */
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Program_X_Matrix_Log[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Program_X_Matrix_Log();
    }
    ...
    */
    ...
    public function to_array() {
        ...
        $db_params['log_xmatrix'] = $this->get_log_xmatrix();
    ...
    public function set_log_xmatrix($value) {
        $this->add_object_field('log_xmatrix', $value);
        $this->log_xmatrix = $value;
    }
    
    public function get_log_xmatrix() {
        return $this->log_xmatrix;
    }
