...
class Orm_Cm_Assessment_Component extends Orm {
    
    protected static $table_name = 'cm_assessment_component';
    
    /**
    * @var $instances Orm_Cm_Assessment_Component[]
    */
    ...
    */
    ...
    /**
    * @return Cm_Assessment_Component_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Assessment_Component_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Cm_Assessment_Component
    */
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Assessment_Component[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Assessment_Component();
    }
    ...
    */
    ...
    /**
     * get title of assessment component depends on active language
