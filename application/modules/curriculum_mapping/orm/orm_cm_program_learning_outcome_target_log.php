...
class Orm_Cm_Program_Learning_Outcome_Target_Log extends Orm {
    
    /**
    * @var $instances Orm_Cm_Program_Learning_Outcome_Target_Log[]
    */
    protected static $instances = array();
    protected static $table_name = 'cm_program_learning_outcome_target_log';
    ...
    */
    ...
    /**
    * @return Cm_Program_Learning_Outcome_Target_Log_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Program_Learning_Outcome_Target_Log_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Cm_Program_Learning_Outcome_Target_Log
    */
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Program_Learning_Outcome_Target_Log[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Program_Learning_Outcome_Target_Log();
    }
