...
class Orm_Cm_Program_Learning_Outcome_Log extends Orm {
    
    protected static $table_name = 'cm_program_learning_outcome_log';
    
    /**
    * @var $instances Orm_Cm_Program_Learning_Outcome_Log[]
    */
    ...
    */
    ...
    protected $log_learning_outcome_id = 0;
    ...
    /**
    * @return Cm_Program_Learning_Outcome_Log_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Program_Learning_Outcome_Log_Model');
    }
    ...
    *
    * @param int $id
    * @return Orm_Cm_Program_Learning_Outcome_Log
    */
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Program_Learning_Outcome_Log[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Program_Learning_Outcome_Log();
    }
    ...
    */
    ...
    public function to_array() {
        ...
        $db_params['log_learning_outcome_id'] = $this->get_log_learning_outcome_id();
    ...
    public function set_log_learning_outcome_id($value) {
        $this->add_object_field('log_learning_outcome_id', $value);
        $this->log_learning_outcome_id = $value;
    }
    
    public function get_log_learning_outcome_id() {
        return $this->log_learning_outcome_id;
    }
