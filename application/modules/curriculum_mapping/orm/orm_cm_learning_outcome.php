...
class Orm_Cm_Learning_Outcome extends Orm {
    
    protected static $table_name = 'cm_learning_outcome';
    
    /**
    * @var $instances Orm_Cm_Learning_Outcome[]
    */
    ...
    */
    ...
    /**
    * @return Cm_Learning_Outcome_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Cm_Learning_Outcome_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Cm_Learning_Outcome[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Cm_Learning_Outcome();
    }
