...
class Orm_Kpi_Survey extends Orm {
    
    /**
    * @var $instances Orm_Kpi_Survey[]
    */
    protected static $instances = array();
    protected static $table_name = 'kpi_survey';
    ...
    */
    ...
    /**
    * @return Kpi_Survey_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Kpi_Survey_Model');
    }
    ...
    */
    ...
    /**
     * remove data of survey (statement and factors ) that related to KPI
     * @param $filters
     * @return mixed
     */
