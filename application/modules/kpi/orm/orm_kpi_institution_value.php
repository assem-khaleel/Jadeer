...
class Orm_Kpi_Institution_Value extends Orm {
    
    /**
    * @var $instances Orm_Kpi_Institution_Value[]
    */
    protected static $instances = array();
    protected static $table_name = 'kpi_institution_value';
    ...
    */
    ...
    /**
    * @return Kpi_Institution_Value_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Kpi_Institution_Value_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Kpi_Institution_Value[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Kpi_Institution_Value();
    }
