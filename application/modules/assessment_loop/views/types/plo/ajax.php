...
if(is_null($program_id) && $assessment_loop->get_item_type()==2) {
    $program_id = $assessment_loop->get_item_type_id();
}
        ...
        <tr>
            <td class="col-lg-3">
                <label class="radio" style="margin: 0 20px;">
                    <input type="radio" name="item_id" <?php echo $assessment_loop->get_item_id() === $plo->get_id() ? 'checked="checked"' : '' ?> value="<?php echo intval($plo->get_id()) ?>" class="px" />
