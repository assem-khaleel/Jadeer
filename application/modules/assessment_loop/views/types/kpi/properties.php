    ...
    <div class="col-sm-9">
        <select name="extra_data[kpi_category_id]" class="form-control" onchange="select_kpis();">
            ...
            foreach(Orm_Kpi::get_categories() as $category_key => $category) {
                $selected = (!is_null($assessment_loop->get_item_from_extra_data('kpi_category_id')) && $category_key == $assessment_loop->get_item_from_extra_data('kpi_category_id')) ? 'selected="selected"' : '';
                ?>
