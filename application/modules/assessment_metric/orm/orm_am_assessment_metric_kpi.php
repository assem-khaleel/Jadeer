...
class Orm_Am_Assessment_Metric_Kpi extends Orm_Am_Assessment_Metric {
    ...
    public function draw_properties() {
        echo Orm::get_ci()->load->view('types/kpi/properties', array('assessment_metric' => $this), true);
    }
    ...
    public function ajax() {
        echo Orm::get_ci()->load->view('types/kpi/ajax', array('assessment_metric' => $this), true);
    }
...
//        $pdf->addToc();
        ...
        $name =  'Assessment Metric (KPI '.Orm_Kpi::get_instance($this->get_item_id())->get_code().').pdf';
