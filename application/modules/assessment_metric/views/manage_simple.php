...
<div class="col-md-12 col-lg-12">
                ...
                <div class="panel-heading-controls col-sm-4">
                    <a class="btn btn-sm pull-right"  data-toggle="ajaxModal"
                       href="/assessment_metric/add_component/<?php echo urlencode($assessment_metric->get_id()); ?>">
                        <span class="btn-label-icon left"><i class="fa fa-plus"></i></span> <?php echo lang('Add') ?>
                    </a>
                </div>
            </div>
        </div>
    ...
    <table class="table">
                ...
                <?php foreach ($all_component as $one_component) { ?>
                    <td>
                        ...
                        <a class="" style="font-size: 15px;" data-toggle="ajaxModal"
                           href="/assessment_metric/edit_component/<?php echo urlencode($assessment_metric->get_id()); ?>/<?php echo $one_component->get_id() ?>">
        ...
        <tr>
            ...
            <?php foreach ($all_component as $one_component) {
                ...
                foreach ($courses as $course) {
                    ?>
                    <td class="col-md-1"><?php echo htmlfilter($course->get_name()) ?></td>
                <?php }
            }?>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <?php foreach ($all_component as $one_component){?>
                <td class="form-group">
                    <input name="average[<?php echo $one_component->get_id()?>]" type="text" id="average" class="form-control"
        ...
        <tr>
            ...
            foreach ($all_component as $one_component) {
                ...
                if($sum_weight == 100){?>
                    <td class="col-md-1"><?php echo round($one_component->get_result(),2) ?></td>
                <?php }else{
