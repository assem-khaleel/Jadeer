...
if(is_null($kpi_category_id)) {
    $kpi_category_id = $assessment_metric->get_item_from_extra_data('kpi_category_id');
}
        ...
        <tr>
            <td class="col-lg-2">
                <label class="radio" style="margin: 0 20px;">
                    <input type="radio" name="item_id" <?php echo $assessment_metric->get_item_id() === $kpi->get_id() ? 'checked="checked"' : '' ?> value="<?php echo intval($kpi->get_id()) ?>" class="px" />
