...
/**
* Class Pm_Phase_Model
*
* @property CI_DB_query_builder | CI_DB_mysqli_driver $db
*/
class Pm_Phase_Model extends CI_Model {
    ...
    * @param int $fetch_as
    *
    * @return Orm_Pm_Phase | Orm_Pm_Phase[] | array | int
    */
    public function get_all($filters = array(), $page = 0, $per_page = 10, $orders = array(), $fetch_as = Orm::FETCH_OBJECTS) {
        ...
        $this->db->select('pp.*');
        $this->db->distinct();
        $this->db->from(Orm_Pm_Phase::get_table_name() . ' AS pp');
        ...
        switch($fetch_as) {
            ...
            return Orm_Pm_Phase::to_object($this->db->get()->row_array());
            break;
            case Orm::FETCH_OBJECTS:
            $objects = array();
            foreach($this->db->get()->result_array() as $row) {
                $objects[] = Orm_Pm_Phase::to_object($row);
            }
            return $objects;
            break;
    ...
    */
    public function insert($params = array()) {
        $this->db->insert(Orm_Pm_Phase::get_table_name(), $params);
    ...
    */
    public function update($id, $params = array()) {
        return $this->db->update(Orm_Pm_Phase::get_table_name(), $params, array('id' => $id));
    }
    ...
    */
    public function delete($id) {
        return $this->db->delete(Orm_Pm_Phase::get_table_name(), array('id' => $id));
    }
