 ...
 */
/** @var string $pager */
/** @var Orm_Data_Course_Status[] $items */
/** @var array $fltr */
?>
<?php if (!isset($pdf) || !$pdf) { ?>
    <div class="box bg-primary p-a-2">
        ...
        <div class="pull-right">
            <a href="/statistics/course_status/1/<?php echo $query_string; ?>" class="btn btn-sm text-default"><span class="btn-label-icon left icon fa fa-file-pdf-o"></span> <?php echo lang('PDF') ?></a>
        </div>
    </div>
...
<div class="table-primary">
    <div class="table-header">
        <div class="table-caption"><?php echo lang('Course Status'); ?></div>
    </div>
    <table class="table table-bordered">
        ...
        <?php foreach ($items as $item) { ?>
            <tr>
                ...
                <td><?php echo htmlfilter($item->get_status_obj()->get_description()); ?></td>
