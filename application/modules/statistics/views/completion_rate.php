 ...
 */
/** @var string $pager */
/** @var Orm_Data_Competion_Rate[] $items */
/** @var array $fltr */
?>
<?php if (!isset($pdf) || !$pdf) { ?>
    <div class="box bg-primary p-a-2">
        ...
        <div class="pull-right">
            <a href="/statistics/completion_rate/1/<?php echo $query_string; ?>" class="btn btn-sm text-default"><span class="btn-label-icon left icon fa fa-file-pdf-o"></span> <?php echo lang('PDF') ?></a>
        </div>
    </div>
...
<div class="table-primary">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th><?php echo lang('Number of Years') ?></th>
            <th><?php echo lang('Graduate Count') ?></th>
        </tr>
        </thead>
        <tbody>
        <?php foreach ($items as $item) { ?>
            <tr>
                <td><?php echo intval($item->get_academic_year()); ?></td>
                ...
                <td><?php echo $item->get_number_of_years(); ?></td>
                <td><?php echo intval($item->get_graduate_count()); ?></td>
            </tr>
        <?php } ?>
        <?php if(empty($items)) { ?>
            <tr>
