 ...
 */
/** @var string $pager */
/** @var Orm_Data_Periodic_Program[] $items */
/** @var array $fltr */
?>
<?php if (!isset($pdf) || !$pdf) { ?>
    <div class="box bg-primary p-a-2">
        ...
        <div class="pull-right">
            <a href="/statistics/periodic/1/<?php echo $query_string; ?>" class="btn btn-sm text_default"><span class="btn-label-icon left icon fa fa-file-pdf-o"></span> <?php echo lang('PDF') ?></a>
        </div>
    </div>
...
<div class="table-primary">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th><?php echo lang('PhD Holder') ?></th>
        ...
        <?php foreach ($items as $item) { ?>
            <tr>
                ...
                <td><?php echo $item->get_phd_holder_count(); ?></td>
