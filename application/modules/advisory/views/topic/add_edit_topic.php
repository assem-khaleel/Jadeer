                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="topic_en" id="editTitle_en" class="form-control"
                               ...
                               value="<?php echo htmlfilter($topic->get_topic_en()); ?>"/>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="topic_ar" id="editTitle_ar" class="form-control"
                               ...
                               value="<?php echo htmlfilter($topic->get_topic_ar()); ?>"/>
                        <?php echo Validator::get_html_error_message('topic_ar'); ?>
                    </div>
                </div>

                <input type="hidden" name="topic_id" id="id" value="<?php echo intval($topic->get_id()) ?>"/>
