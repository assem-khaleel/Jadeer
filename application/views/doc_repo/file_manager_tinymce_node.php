...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
        ...
        var elf = $('#elfinder').elfinder({
            ...
            url: '<?php echo $this->config->item('index_page') ? "/{$this->config->item('index_page')}" : '' ?>/doc_repo/file_manager_connector/tinymce_node/<?php echo (int)$node_id; ?>', // connector URL (REQUIRED)
