 ...
 *
 */
class College_goal extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->view_params['page_header'] = $this->load->view('/common/page_header', array(
            'title' => lang('College Goals') . ' : ' . htmlfilter($this->college->get_name()),
            'icon' => 'fa fa-suitcase'
        ), true);
    ...
    public function index()
    {
        ...
        $this->breadcrumbs->push(htmlfilter($this->college->get_name()), '/college_goal?college_id=' . $this->college->get_id());

        $html = '<div class="col-md-9 col-lg-10">';
        $html .= $this->college->draw_goals();
        $html .= '</div></div>';
