 ...
 * Time: 9:16 AM
 */
class Institution_goal extends MX_Controller
{
    ...
    public function index()
    {
        ...
        // add breadcrumbs
        $this->breadcrumbs->push(lang('Goals'), '/institution/goal');

        $html = '<div class="col-md-9 col-lg-10">';
        $html .= $this->institution->draw_goals();
        $html .= '</div></div>';
