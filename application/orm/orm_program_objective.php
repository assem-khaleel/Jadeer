...
class Orm_Program_Objective extends Orm {
    
    protected static $table_name = 'program_objective';
    
    /**
    * @var $instances Orm_Program_Objective[]
    */
    ...
    */
    ...
    /**
    * @return Program_Objective_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Program_Objective_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Program_Objective[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Program_Objective();
    }
    ...
    */
    ...
    public function get_setup_id() {
        return $this->program_id;
    }
    public function set_reference_id($id) {
        $this->set_program_id($id);
    }
}
