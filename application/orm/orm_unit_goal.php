...
class Orm_Unit_Goal extends Orm {
    
    protected static $table_name = 'unit_goal';
    
    /**
    * @var $instances Orm_Unit_Goal[]
    */
    ...
    */
    ...
    /**
    * @return Unit_Goal_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Unit_Goal_Model');
    }
