...
class Orm_Institution_Goal extends Orm {
    

    /**
    * @var $instances Orm_Institution_Goal[]
    */
    protected static $instances = array();
    protected static $table_name = 'institution_goal';
    ...
    */
    ...
    /**
    * @return Institution_Goal_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Institution_Goal_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Institution_Goal[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Institution_Goal();
    }
