...
class Orm_College_Goal extends Orm {
    
    protected static $table_name = 'college_goal';
    
    /**
    * @var $instances Orm_College_Goal[]
    */
    ...
    */
    ...
    /**
    * @return College_Goal_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('College_Goal_Model');
    }
