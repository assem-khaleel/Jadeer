...
class Orm_Unit_Objective extends Orm {
    
    protected static $table_name = 'unit_objective';
    
    /**
    * @var $instances Orm_Unit_Objective[]
    */
    ...
    */
    ...
    /**
    * @return Unit_Objective_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Unit_Objective_Model');
    }
