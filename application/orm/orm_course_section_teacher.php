...
class Orm_Course_Section_Teacher extends Orm {

    /**
    * @var $instances Orm_Course_Section_Teacher[]
    */
    protected static $instances = array();
    protected static $table_name = 'course_section_teacher';
    ...
    */
    ...
    /**
    * @return Course_Section_Teacher_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Course_Section_Teacher_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_Course_Section_Teacher[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_Course_Section_Teacher();
    }
    ...
    */
    ...
    public static function get_course_ids($teacher_id = null, $semester_id = null)
    {
        ...
        $section_ids = self::get_section_ids($teacher_id);
    ...
    public static function get_section_ids($teacher_id = null)
    {
        if (is_null($teacher_id)) {
            $teacher_id = Orm_User::get_logged_user_id();
        }

        $section_ids = array_column(self::get_model()->get_all(array('user_id' => $teacher_id), 0, 0, array(), Orm::FETCH_ARRAY), 'section_id');
