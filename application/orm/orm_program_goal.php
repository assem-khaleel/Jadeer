...
class Orm_Program_Goal extends Orm {
    
    protected static $table_name = 'program_goal';
    
    /**
    * @var $instances Orm_Program_Goal[]
    */
    ...
    */
    ...
    /**
    * @return Program_Goal_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('Program_Goal_Model');
    }
