...
class Orm_College_Objective extends Orm {
    
    protected static $table_name = 'college_objective';
    
    /**
    * @var $instances Orm_College_Objective[]
    */
    ...
    */
    ...
    /**
    * @return College_Objective_Model
    */
    public static function get_model() {
        return Orm::get_ci_model('College_Objective_Model');
    }
    ...
    * @param array $orders
    *
    * @return Orm_College_Objective[] | int
    */
    ...
    */
    public static function get_one($filters = array(), $orders = array()) {
        ...
        return new Orm_College_Objective();
    }
